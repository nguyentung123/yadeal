  ...
  ?>
       <div class="slide-item <?php echo $name_color_img; ?>">
        ...
        <div class="slide-item-image">
         <img src="<?php echo $name_img; ?>" alt="<?php echo get_the_title() . $name_color_img; ?>">
        </div>
      ...
      <ul class="slide-dots-custom">
       ...
       <li class="<?php echo $img_item['product_color_name'];
if ($key == 0) {
 echo ' active-color';
} ?> ">
    ...
    <div class="bike-detail-summary">
     ...
     <h4 class="product-price">
      <span style="font-size: 0.75em">Giá bán lẻ đề xuất</span><br>
      <b><?php echo number_format(get_field('product_price')); ?> VNĐ</b>
      <?php if (get_field('product_is_sale')):
 echo '<span class="sale-label" style="display: block;
				                          font-size: 0.7em; color: #fe2219; margin-top: 0.25em; font-weight: bolder;">' . get_field('product_is_sale') . '</span>';
endif; ?>
     </h4>
...
if ($productImageSet and count($productImageSet) >= 3): ?>
    ...
    <ul class="real-img-slider">
     ...
     <li class="slide-item">
      <a class="venobox" href="<?php echo $image['url']; ?>">
       <img draggable="false" src="<?php echo $image['url']; ?>" style="width: 100%;">
      </a>
     </li>
     <?php endforeach; ?>
 ...
 <div class="social-comment" style="padding: 3em 0 4em;">
  ...
  <div class="container small">
   <div class="fb-comments" data-href="https://www.yadeavietnam.vn/<?php echo get_post_field('post_name'); ?>"
...
<div class="signup-info-modal">
 ...
 <div class="signup-info-modal-dialog">
  ...
  <div class="right-content">
   ...
   <a class="right-cta track-this-button" id="specs-page-popup-findstore-<?php echo get_post_field('post_name'); ?>-btn"
