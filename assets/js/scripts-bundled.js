...
function () {
  ...
  _createClass(Home, [{
    ...
    value: function bindEvents() {
      ...
      this.$zaloHolder.on('click', function () {
        if (!_this.$zaloHolder.hasClass('active')) {
          _this.$zaloHolder.addClass('active');
        }
      });
    }
    /* ===================================
...
function () {
  ...
  _createClass(Supports, [{
    ...
    value: function SetupTopicControl() {
      ...
      this.$mainTopicToggler.on('click', function (e) {
      ...
      this.$subTopicToggler.on('click', function (e) {
        if (_this2.allowChangeTopic) {
          ...
          $(e.target).siblings('.sub-topic-content').slideToggle('fast', function () {
            // Reopen animation Blocking
            _this2.allowChangeTopic = true;
          });
        }
