  ...
  _createClass(Slider, [{
    ...
    value: function bindEvents() {
      ...
      if (this.slider1.length > 0) {
        this.slider1.on('init reInit', function (e, slick, currentSlide, nextSlide) {
          ...
          _.forEach(_this.videoPlayerArray, function (value) {
            value.player.mute();
            value.player.addEventListener('onStateChange', function (data) {
              if (data.data == 0) {
                slick.slickNext();
              }
            });
          ...
          if (_this.indexRefVideoArray.length > 0) {
            if (_this.indexRefVideoArray[0].slide == '0') {
              _this.videoPlayerArray[_this.indexRefVideoArray[0].index].player.playVideo();
            } else {
              slick.slickPlay();
            }
          } else {
        ...
        this.slider1.on('afterChange', function (e, slick, currentSlide, nextSlide) {
        ...
        this.slider1.on('beforeChange', function (e, slick, currentSlide, nextSlide) {
          ...
          $nextPage.html('0' + i).removeClass('inactive removed').addClass('active'); // Youtube Processing

          var isVideoSlide = false;

          _this.StopAllVideo();

          if (_this.videoPlayerArray.length > 0) {
            _.each(_this.indexRefVideoArray, function (value) {
              if (value.slide == nextSlide) {
                isVideoSlide = true;
                slick.slickPause();

                _this.videoPlayerArray[value.index].player.playVideo();
              }
            });
          }
      ...
      this.slider2.on('init reInit', function (e, slick, currentSlide, nextSlide) {
      ...
      this.slider2.on('afterChange', function (e, slick, currentSlide, nextSlide) {
    ...
    value: function YoutubeSetup() {
      ...
      if (this.slider1VideoSlides.length > 0) {
        _.each(this.slider1VideoSlides, function (value) {
          // Contain Video Slide In Slider And Index Of Video Object Inside videoPlayerArray to Reference
          _this2.indexRefVideoArray.push({
            slide: $(value).data('slide'),
            index: _this2.videoPlayerArray.length
          });

          _this2.videoPlayerArray.push({
            element: $(value),
            state: 0,
            player: (0, _youtubePlayer.default)(value, {
    ...
    value: function StopAllVideo() {
      if (this.videoPlayerArray.length > 0) {
        _.forEach(this.videoPlayerArray, function (value) {
