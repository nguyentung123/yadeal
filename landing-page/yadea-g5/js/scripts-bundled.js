...
var contextFadeIn = function contextFadeIn() {
  ...
  if ($containerBlock != null) {
    ...
    return TweenMax.to([$title, $subTitle, $detail, $line].concat(_toConsumableArray(additionalElement)), speed, {
      opacity: 1,
      y: 0,
      x: 0,
      scaleX: 1,
    ...
    return TweenMax.to(_toConsumableArray(additionalElement), speed, {
      opacity: 1,
      y: 0,
      x: 0,
      scaleX: 1,
...
function () {
  ...
  _createClass(Home, [{
    ...
    key: "PriceTagScroll",
    value: function PriceTagScroll() {
      g5Listener.on('price-tag-fixed', function () {
        $('#page-header').addClass('scrolling-menu');
      });
      g5Listener.on('price-tag-normal', function () {
        $('#page-header').removeClass('scrolling-menu');
      });
    }
  }, {
    key: "SetupPriceTagMenu",
    value: function SetupPriceTagMenu() {
      var _this4 = this;
      ...
      this.$openPriceTagMenu.on('click', function () {
        _this4.$priceTagMenu.slideDown('normal');

        _this4.$iconHolder.addClass('is-showing');
      });
      this.$closePriceTagMenu.on('click', function () {
...
function () {
  ...
  _createClass(Colors, [{
    ...
    value: function SetupMobileAnimation() {
      ...
      $('.color-slider-controller.prev-color-slide').on('click', function () {
        $('.g5-color-list-mb').slick('slickPrev');
      });
      $('.color-slider-controller.next-color-slide').on('click', function () {
          ...
          if (window.innerWidth > 768) {
            TweenMax.to(this.$mainContextBlock, 0.5, {
              ...
              onComplete: function onComplete() {
                _this3.$mainContextBlock.addClass('right');

                TweenMax.set(_this3.$mainContextBlock, {
                  x: 0
                });
                TweenMax.to(_this3.$mainContextBlock, 0.5, {
                  opacity: 1,
                  delay: 0.1
                });
              }
        ...
        case 2:
          if (window.innerWidth > 768) {
            ...
            TweenMax.to(this.$mainContextBlock, 0.5, {
              opacity: 0,
              onComplete: function onComplete() {
                _this3.$mainContextBlock.removeClass('right');

                TweenMax.set(_this3.$mainContextBlock, {
                  x: -_this3.elemWidth * 0.55
                });
                TweenMax.to(_this3.$mainContextBlock, 0.5, {
                  opacity: 1,
                  delay: 0.1
  ...
  _createClass(GPS, [{
    ...
    value: function bindEvents() {
      ...
      g5Listener.on('gps-anim', function () {
        (0, _utils.contextFadeIn)(_this.$context, function () {
          TweenMax.to(_this.$mapImg, 0.75, {
            opacity: 1,
            rotationY: 0,
            y: 0,
            scaleY: 1,
            onComplete: function onComplete() {
              TweenMax.to(_this.$pinImg, 0.35, {
                y: 0,
                opacity: 1,
                onComplete: function onComplete() {
                  _this.$pinImg.addClass('toggling');
                }
              });
            }
          });
  ...
  _createClass(Scan, [{
    ...
    value: function DoCheckingAnimationEffect() {
      ...
      timeline.add([TweenMax.to(this.$phoneMap, 0.5, {
        opacity: 1
      }), TweenMax.to(this.$phoneHolder, 0.5, {
        opacity: 0,
        delay: 0.15
      })], '+=0.25');
      timeline.play();
  ...
  _createClass(Water, [{
    ...
    value: function bindEvents() {
      ...
      g5Listener.on('water-anim', function () {
        TweenMax.to(_this.$background, 0.5, {
          y: 0,
          opacity: 1,
          onComplete: function onComplete() {
            (0, _utils.contextFadeIn)(_this.$context);
