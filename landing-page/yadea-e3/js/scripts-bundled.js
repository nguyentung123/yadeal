...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(20)(module), __webpack_require__(4)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweenLite__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TimelineLite__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TimelineMax__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__TweenMax__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__CSSPlugin__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__AttrPlugin__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__RoundPropsPlugin__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__DirectionalRotationPlugin__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__BezierPlugin__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__EasePack__ = __webpack_require__(11);
...
var _home = _interopRequireDefault(__webpack_require__(13));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

$(document).ready(function () {
  var homePage = new _home.default();
});
...
var _TweenMax = __webpack_require__(0);

var _common = _interopRequireDefault(__webpack_require__(14));

var _banner = _interopRequireDefault(__webpack_require__(15));

var _design = _interopRequireDefault(__webpack_require__(16));

var _container = _interopRequireDefault(__webpack_require__(17));

var _light = _interopRequireDefault(__webpack_require__(18));

var _waterResistance = _interopRequireDefault(__webpack_require__(19));

var _positionSeat = _interopRequireDefault(__webpack_require__(23));

var _screen = _interopRequireDefault(__webpack_require__(24));

var _battery = _interopRequireDefault(__webpack_require__(25));

var _control = _interopRequireDefault(__webpack_require__(26));

var _antiThief = _interopRequireDefault(__webpack_require__(27));

var _savingEnergy = _interopRequireDefault(__webpack_require__(28));
...
function () {
  ...
  function Home() {
    ...
    window.e3Listener = new _utils.pageListener(); // Behavior Use For All Page

    var banner = new _banner.default();
    var design = new _design.default();
    var container = new _container.default();
    var light = new _light.default();
    var water = new _waterResistance.default();
    var positionSeat = new _positionSeat.default();
    var screen = new _screen.default();
    var battery = new _battery.default();
    var control = new _control.default();
...
function () {
  ...
  _createClass(Banner, [{
    ...
    value: function BannerSetup() {
      ...
      _TweenMax.TweenMax.set(this.$bikeImage, {
        opacity: 0,
        x: window.innerWidth * 0.02
      });

      _TweenMax.TweenMax.set(this.$bannerIcon, {
        opacity: 0,
        x: -window.innerWidth * 0.02
      });

      _TweenMax.TweenMax.set(this.$bannerCTA, {
        opacity: 0
      });
      ...
      this.bannerTimeline.add(_TweenMax.TweenMax.to(this.$bikeImage, 0.5, {
        opacity: 1,
        x: 0
      }));
      this.bannerTimeline.add(_TweenMax.TweenMax.to(this.$bannerIcon, 0.5, {
        opacity: 1,
        x: 0
      }), '-=0.2');
      this.bannerTimeline.add(_TweenMax.TweenMax.to(this.$bannerCTA, 0.15, {
        opacity: 1
      }), '-=0.1');
    }
  }, {
    ...
    value: function BannerInit() {
      ...
      e3Listener.on('page-start', function () {
...
function () {
  ...
  _createClass(Design, [{
    ...
    value: function DesignSetup() {
      ...
      _TweenMax.TweenMax.set(this.$imageList, {
        opacity: 0,
        y: window.innerWidth * 0.01
      });

      this.designTimeline = new TimelineMax({
        paused: true
      });
      this.designTimeline.add(_TweenMax.TweenMax.to(this.$mainContent, 0.5, {
        opacity: 1
      }));
      this.designTimeline.add(_TweenMax.TweenMax.to(this.$imageList, 0.5, {
        opacity: 1,
        y: 0
      }), '-=0.1');
    }
    ...
    key: "DesignAnimation",
    value: function DesignAnimation() {
      var _this = this;

      e3Listener.on('design-anim', function () {
        _this.designTimeline.play();
      });
    }
  }]);
...
function () {
  ...
  _createClass(Container, [{
    ...
    value: function ContainerSetup() {
      ...
      _TweenMax.TweenMax.set(this.$containerImg, {
        opacity: 0,
        y: window.innerWidth * 0.01
      });

      _TweenMax.TweenMax.set(this.$containerInside, {
        opacity: 0
      });

      this.ContainerTimeline = new TimelineMax({
        paused: true
      });
      this.ContainerTimeline.add(_TweenMax.TweenMax.to(this.$mainContent, 0.5, {
        opacity: 1,
        x: 0
      }));
      this.ContainerTimeline.add(_TweenMax.TweenMax.to(this.$containerImg, 0.5, {
        opacity: 1,
        y: 0
      }), '-=0.15');
      this.ContainerTimeline.add(_TweenMax.TweenMax.to(this.$containerInside, 0.5, {
        opacity: 1
      }), '-=0.1');
    }
  }, {
    key: "ContainerInit",
    value: function ContainerInit() {
      var _this = this;

      e3Listener.on('container-anim', function () {
        _this.ContainerTimeline.play();
      });
    }
  }]);
...
function () {
  ...
  _createClass(Light, [{
    ...
    key: "LightSectionSetup",
    value: function LightSectionSetup() {
      var _this = this;
      ...
      _TweenMax.TweenMax.set(this.$lightBg, {
        '-webkit-filter': 'brightness(0.35)'
      });

      _TweenMax.TweenMax.set(this.$lightLedEffect, {
        opacity: 0
      });
      ...
      this.LightTimeline.add(_TweenMax.TweenMax.to(this.$mainContent, 0.5, {
        opacity: 1,
        x: 0
      }));
      this.LightTimeline.add('light-effect');
      this.LightTimeline.add([_TweenMax.TweenMax.to(this.$lightLedEffect, 0.65, {
        opacity: 1
      }), _TweenMax.TweenMax.to(this.$lightBg, 0.65, {
        '-webkit-filter': 'brightness(1)'
      })], '-=0.05');
      this.LightTimeline.add('light-end');
    }
  }, {
    key: "LightSectionInit",
    value: function LightSectionInit() {
      var _this2 = this;

      e3Listener.on('light-anim', function () {
    ...
    value: function LightRepeat() {
      ...
      this.LightTimeline.tweenFromTo('light-end', 'light-effect', {
        ...
        onComplete: function onComplete() {
          setTimeout(function () {
            _this3.LightTimeline.play('light-effect');
          }, 800);
        }
      });
    }
...
function () {
  ...
  _createClass(WaterResistance, [{
    ...
    value: function WaterResistanceSetup() {
      ...
      this.$bikeLayer = $('.effect-holder .bike-holder'); // Setup Init State

      _TweenMax.TweenMax.set(this.$waterMainContent, {
        opacity: 0,
        y: window.innerWidth * 0.05
      });

      _TweenMax.TweenMax.set([this.$waterLayer1, this.$waterLayer2], {
        opacity: 0,
        y: window.innerWidth * 0.12
      });

      _TweenMax.TweenMax.set(this.$bikeLayer, {
        opacity: 0,
        x: window.innerWidth * 0.05
      });

      this.WaterTimeline = new TimelineMax({
        paused: true
      });
      this.WaterTimeline.add('water-start');
      this.WaterTimeline.add(_TweenMax.TweenMax.to(this.$waterMainContent, 0.5, {
        opacity: 1,
        y: 0
      }));
      this.WaterTimeline.add('content-appear');
      this.WaterTimeline.add(_TweenMax.TweenMax.to(this.$bikeLayer, 0.75, {
        opacity: 1,
        x: 0
      }));
      this.WaterTimeline.add('bike-appear');
      this.WaterTimeline.add([_TweenMax.TweenMax.to(this.$waterLayer1, 1.7, {
        opacity: 1,
        y: 0,
        ease: Power1.easeOut
      }), _TweenMax.TweenMax.to(this.$waterLayer2, 1.4, {
        opacity: 1,
        y: 0,
        delay: 0.22,
        ease: Power1.easeOut
    ...
    value: function WaterResistanceInit() {
      ...
      e3Listener.on('water-resistance-anim', function () {
        _this.WaterTimeline.play();
      });
    }
  }]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweenLite__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TweenMaxBase__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CSSPlugin__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__AttrPlugin__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__RoundPropsPlugin__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__DirectionalRotationPlugin__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__TimelineLite__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__TimelineMax__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__BezierPlugin__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__EasePack__ = __webpack_require__(11);
...
function () {
  ...
  function PositionSeat() {
    _classCallCheck(this, PositionSeat);
  ...
  _createClass(PositionSeat, [{
    ...
    value: function PositionSetup() {
      ...
      this.$bikeDraw = this.$effectHolder.find('.draw-img'); // Set Init State
      ...
      _TweenMax.TweenMax.set(this.$bikeCore, {
        opacity: 1
      });

      _TweenMax.TweenMax.set(this.$bikeDraw, {
        opacity: 0
      });

      this.PositionTimeline = new TimelineMax({
        paused: true
      });
      this.PositionTimeline.add('anim-start');
      this.PositionTimeline.add(_TweenMax.TweenMax.to(this.$mainContent, 0.5, {
        opacity: 1,
        y: 0
      }));
      this.PositionTimeline.add('main-cotnent-appear');
      this.PositionTimeline.add(_TweenMax.TweenMax.to(this.$effectHolder, 0.65, {
        opacity: 1,
        x: 0,
        delay: 0.075
      }));
      this.PositionTimeline.add('bike-appear');
      this.PositionTimeline.add([_TweenMax.TweenMax.to(this.$bikeCore, 0.65, {
        opacity: 0.5,
        scale: 1
      }), _TweenMax.TweenMax.to(this.$bikeDraw, 0.65, {
        opacity: 1,
        scale: 1
      })], '+=0.22');
    }
    ...
    key: "PositionInit",
    value: function PositionInit() {
      var _this = this;

      e3Listener.on('position-seat-anim', function () {
        _this.PositionTimeline.play();
      });
    }
  }]);
...
function () {
  ...
  _createClass(Screen, [{
    ...
    value: function ScreenSetup() {
      ...
      this.$markerPointDot = this.$screenDisplay.find('.marker .dot'); // Init State
      ...
      _TweenMax.TweenMax.set(this.$chargingContent, {
        opacity: 0
      });
      ...
      _TweenMax.TweenMax.set(this.$markerPoint, {
        autoAlpha: 0
      });

      this.screenTimeline = new TimelineMax({
        paused: true,
        onComplete: function onComplete() {
          _this.ShowMarker();
        }
      ...
      this.screenTimeline.add(_TweenMax.TweenMax.to(this.$mainContent, 0.5, {
        y: 0,
        opacity: 1
      }));
      this.screenTimeline.add('main-content-appear');
      this.screenTimeline.add(_TweenMax.TweenMax.to(this.$effectHolder, 1, {
        y: 0,
        opacity: 1
      }));
      this.screenTimeline.add('effect-holder-appear');
      this.screenTimeline.add(_TweenMax.TweenMax.to(this.$chargingContent, 0.5, {
        opacity: 1
      }), '-=0.2');
    }
  }, {
    key: "ScreenInit",
    value: function ScreenInit() {
      var _this2 = this;

      e3Listener.on('screen-anim', function () {
        _this2.screenTimeline.play();
      });
    }
  }, {
    key: "ShowMarker",
    value: function ShowMarker() {
      _TweenMax.TweenMax.to(this.$markerPoint, 0.25, {
        autoAlpha: 1
      });
    }
  }]);
...
function () {
  ...
  _createClass(BatteryCharging, [{
    ...
    key: "BatterySectionSetup",
    value: function BatterySectionSetup() {
      ...
      this.$effectItem = this.$effectHolder.find('.effect-item-description'); // Init State
      ...
      _TweenMax.TweenMax.set(this.$effectItem, {
        opacity: 0
      });

      this.batteryTimeline = new TimelineMax({
        paused: true
      });
      this.batteryTimeline.to(this.$mainContent, 0.5, {
        opacity: 1,
        y: 0
      });
      this.batteryTimeline.to(this.$effectHolder, 0.75, {
        opacity: 1,
        y: 0
      }, '-=0.1');
      this.batteryTimeline.to(this.$effectItem, 0.2, {
        opacity: 1
      });
    }
  }, {
    key: "BatterySectionInit",
    value: function BatterySectionInit() {
      var _this = this;

      e3Listener.on('battery-anim', function () {
        _this.batteryTimeline.play();
      });
    }
  }]);
...
function () {
  ...
  _createClass(Control, [{
    ...
    value: function ControlSetup() {
      ...
      _TweenMax.TweenMax.set([this.$leftMark, this.$rightMark], {
        opacity: 0
      });

      this.controlDesktopTimeline = new TimelineMax({
        paused: true,
        onComplete: function onComplete() {
          if (window.innerWidth <= 768) {
            _this.SetupMobileEffect();
          }
        }
      });
      this.controlDesktopTimeline.add('anim-start');
      this.controlDesktopTimeline.add(_TweenMax.TweenMax.to(this.$mainContent, 0.5, {
        opacity: 1,
        y: 0
      }));
      this.controlDesktopTimeline.add(_TweenMax.TweenMax.to(this.$bikeImage, 0.75, {
        opacity: 1,
        y: 0
      }), '-=0.15');
      this.controlDesktopTimeline.add(_TweenMax.TweenMax.to([this.$leftMark, this.$rightMark], 0.5, {
        opacity: 1
      }));
    ...
    value: function ControlInit() {
      ...
      e3Listener.on('easy-control-anim', function () {
        _this2.controlDesktopTimeline.play();
      });
    }
  }, {
    key: "SetupMobileEffect",
    value: function SetupMobileEffect() {
      var _this3 = this;
      ...
      var distanceToMove = this.$controlHolder.width();
      this.allowToggle = true;
      this.$toRightSide.on('click', function () {
        console.log(_this3.currentState);

        if (_this3.allowToggle && _this3.currentState == 'stage-left') {
          _this3.allowToggle = false;

          _this3.$controlHolder.removeClass(_this3.currentState);

          _this3.currentState = 'stage-right';

          _this3.$controlHolder.addClass(_this3.currentState);

          _TweenMax.TweenMax.set($('.description-holder .item-2 .desc'), {
            opacity: 0,
            y: 12
          });

          _TweenMax.TweenMax.to(_this3.$effectHolder, 1.25, {
            x: -distanceToMove
          });

          _TweenMax.TweenMax.to(_this3.$detailHolder, 1.25, {
            x: -distanceToMove,
            onComplete: function onComplete() {
              _this3.allowToggle = true;
            }
          ...
          _TweenMax.TweenMax.to($('.description-holder .item-2 .desc'), 0.5, {
            opacity: 1,
            y: 0,
      ...
      this.$toLeftSide.on('click', function () {
        console.log(_this3.currentState);

        if (_this3.allowToggle && _this3.currentState == 'stage-right') {
          _this3.allowToggle = false;

          _this3.$controlHolder.removeClass(_this3.currentState);

          _this3.currentState = 'stage-left';

          _this3.$controlHolder.addClass(_this3.currentState);

          _TweenMax.TweenMax.set($('.description-holder .item-1 .desc'), {
            opacity: 0,
            y: 12
          });
          ...
          _TweenMax.TweenMax.to($('.description-holder .item-1 .desc'), 0.5, {
            opacity: 1,
            y: 0,
            ease: _gsap.Power1.easeOut,
            delay: 0.8
...
function () {
  ...
  _createClass(AntiThief, [{
    ...
    value: function AntiThiefSetup() {
      ...
      this.$antiThiefSection = $('.section-anti-thief');
    ...
    value: function AntiThiefInit() {
      ...
      e3Listener.on('anti-thief-anim', function () {
...
function () {
   ...
   *  CONSTRUCTOR
   * =================================== */
  function SavingEnergy() {
    _classCallCheck(this, SavingEnergy);
  ...
  _createClass(SavingEnergy, [{
    key: "bindEvents",
    value: function bindEvents() {
      // Saving Energy Block 1
      this.SavingEnergy1Setup();
      this.SavingEnergy1Init(); // Saving Energy Block 2
    ...
    key: "SavingEnergy1Setup",
    value: function SavingEnergy1Setup() {
      ...
      this.$backgroundHolder = this.$savingEnergy1.find('.background-holder'); // Init State

      this.bgHolderHeight = this.$backgroundHolder.height();

      _TweenMax.TweenMax.set(this.$mainContent1, {
        opacity: 0,
        y: window.innerWidth * 0.02
      });
      ...
      _TweenMax.TweenMax.set(this.$backgroundHolder, {
        y: 0
      });

      this.saving1Animation = new TimelineMax({
        paused: true
      });
      this.saving1Animation.add('anim-start');
      this.saving1Animation.add(_TweenMax.TweenMax.to(this.$backgroundHolder, 1.5, {
        y: this.bgHolderHeight,
        ease: Power1.easeOut
      }));
      this.saving1Animation.add(_TweenMax.TweenMax.to(this.$bikeImage, 0.75, {
        opacity: 1,
        x: 0
      }), '-=0.35');
      this.saving1Animation.add(_TweenMax.TweenMax.to(this.$mainContent1, 0.5, {
        opacity: 1,
        y: 0
      }), '-=0.2');
    }
  }, {
    key: "SavingEnergy1Init",
    value: function SavingEnergy1Init() {
      var _this = this;

      e3Listener.on('saving-energy-anim', function () {
        _this.saving1Animation.play();
      });
    }
  }, {
    key: "SavingEnergy2Setup",
    value: function SavingEnergy2Setup() {
      this.$savingEnergy2 = $('.section-saving-energy-2');
      this.$mainContent2 = this.$savingEnergy2.find('.main-content');
      this.$savingEnergyGallery = this.$savingEnergy2.find('.saving-energy-feature'); // Init State

      _TweenMax.TweenMax.set(this.$mainContent2, {
        opacity: 0,
        y: window.innerWidth * 0.02
      });

      _TweenMax.TweenMax.set(this.$savingEnergyGallery, {
        opacity: 0,
        y: window.innerWidth * 0.03
      });

      this.saving2Animation = new TimelineMax({
        paused: true
      });
      this.saving2Animation.add(_TweenMax.TweenMax.to(this.$mainContent2, 0.5, {
        opacity: 1,
        y: 0
      }));
      this.saving2Animation.add(_TweenMax.TweenMax.to(this.$savingEnergyGallery, 0.75, {
        opacity: 1,
        y: 0
      }));
    }
  }, {
    key: "SavingEnergy2Init",
    value: function SavingEnergy2Init() {
      var _this2 = this;

      e3Listener.on('saving-energy-2-anim', function () {
        _this2.saving2Animation.play();
      });
    }
  }]);
...
function () {
  ...
  _createClass(Features, [{
    ...
    key: "FeatureSetup",
    value: function FeatureSetup() {
      this.$featureSection = $('.section-features');
      this.$mainContent = this.$featureSection.find('.main-content');
      this.$featureImgs = this.$featureSection.find('.feature-list'); // Init State
      ...
      _TweenMax.TweenMax.set(this.$featureImgs, {
        opacity: 0,
        y: window.innerWidth * 0.03
      });

      this.featureTimeline = new TimelineMax({
        paused: true
      });
      this.featureTimeline.to(this.$mainContent, 0.5, {
        opacity: 1,
        y: 0
      });
      this.featureTimeline.to(this.$featureImgs, 0.75, {
        opacity: 1,
        y: 0
      }, '-=0.1');
    }
    ...
    value: function FeatureInit() {
      ...
      e3Listener.on('features-anim', function () {
        _this.featureTimeline.play();
      });
    }
  }]);
