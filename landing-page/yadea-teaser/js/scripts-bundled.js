...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(27)(module), __webpack_require__(28)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweenLite__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TimelineLite__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TimelineMax__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__TweenMax__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__CSSPlugin__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__AttrPlugin__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__RoundPropsPlugin__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__DirectionalRotationPlugin__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__BezierPlugin__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__EasePack__ = __webpack_require__(9);
...
var _common = _interopRequireDefault(__webpack_require__(11));

var _home = _interopRequireDefault(__webpack_require__(12));

var _clock = _interopRequireDefault(__webpack_require__(33));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

$(document).ready(function () {
  // Behavior Use For All Page
  var common = new _common.default(); // Behavior for page-wrapper with ID = "home-page"
...
var _youtubePlayer = _interopRequireDefault(__webpack_require__(13));

var _infoDate = _interopRequireDefault(__webpack_require__(26));

var _prizeSection = _interopRequireDefault(__webpack_require__(31));

var _banner = _interopRequireDefault(__webpack_require__(32));
...
function () {
  ...
  function Home() {
    ...
    var dateSection = new _infoDate.default();
    var prizeSection = new _prizeSection.default();
    this.bindEvents();
  }
  /* ===================================
   *  EVENTS
  ...
  _createClass(Home, [{
    ...
    value: function bindEvents() {
      ...
      this.NewsSliderSetup(); // Sub Menu Fixed Top Setup

      this.$pageHeader = $('#page-header');
      this.SetupFixedTopSubMenu(); // Sub Menu Toggle On Mobile
      ...
      this.SmoothScrollingSetup(); // Force Number Phone Input Only
    ...
    key: "ColorSliderSetup",
    value: function ColorSliderSetup() {
      var _this = this;
    ...
    value: function SetupMbMenuToggle() {
      ...
      this.$menuToggleButton.on('click', function (e) {
        if (_this2.allowToggle) {
          // After 300ms, allow Toggle back to true
          _this2.allowToggle = false;
          setTimeout(function () {
            _this2.allowToggle = true;
          }, 300);

          if (!_this2.$subHeader.hasClass('showing-sub-menu')) {
            _this2.$subHeader.addClass('showing-sub-menu');

            _this2.$subMenu.slideDown('fast');
          } else {
            _this2.$subHeader.removeClass('showing-sub-menu');

            _this2.$subMenu.slideUp('fast');
          }
        }
      });
    ...
    value: function SetupVideoPlayer() {
      ...
      $('.play-modal-video').on('click', function (e) {
        _this4.videoCode = 'BnRxdYVE6KA'; // Default Youtube Video ID

        if ($(e.target).parent('.play-modal-video').length > 0) {
          _this4.videoCode = $(e.target).parent('.play-modal-video').data('video-id');
        } else {
          _this4.videoCode = $(e.target).data('video-id');
        }

        _this4.PlayModalClip(_this4.videoCode);
      });
    ...
    key: "ApplyInfomationSetup",
    value: function ApplyInfomationSetup() {
      var _this7 = this;

      this.$openApplyModal = $('.apply-info-modal');
      this.$closeApplyModal = $('.close-apply-modal');
      this.$applyModalElement = $('.apply-g5-event-modal');
      this.$openApplyModal.on('click', function () {
        _this7.$applyModalElement.addClass('active');

        $('body, html').addClass('show-modal');
      });
      this.$closeApplyModal.on('click', function () {
        _this7.$applyModalElement.removeClass('active');
...
var _sister = __webpack_require__(14);

var _sister2 = _interopRequireDefault(_sister);

var _loadYouTubeIframeApi = __webpack_require__(15);
...
var _loadScript = __webpack_require__(16);
...
var _gsap = _interopRequireWildcard(__webpack_require__(1));
...
function () {
  ...
  function DateSection() {
    ...
    this.$firstLayer = $('.first-layer'); // Desktop Main Element
  ...
  _createClass(DateSection, [{
    ...
    value: function bindEvents() {
      ...
      if (window.innerWidth > 768) {
        ...
        $(window).on('scroll', function () {
          if (window.pageYOffset > _this.$designDesktopSection.offset().top - window.innerHeight * 0.65 && window.pageYOffset < _this.$designDesktopSection.offset().top + window.innerHeight * 0.5) {
            _this.desktopDesignTimeline.play();
          }

          if (window.pageYOffset > _this.$smartDesktopSection.offset().top - window.innerHeight * 0.65 && window.pageYOffset < _this.$smartDesktopSection.offset().top + window.innerHeight * 0.5) {
            _this.desktopSmartTimeline.play();
          }

          if (window.pageYOffset > _this.$performanceDesktopSection.offset().top - window.innerHeight * 0.65 && window.pageYOffset < _this.$performanceDesktopSection.offset().top + window.innerHeight * 0.5) {
            _this.desktopPerformanceTimeline.play();
          }

          if (window.pageYOffset > _this.$layoutFinal.offset().top - window.innerHeight * 0.65 && window.pageYOffset < _this.$layoutFinal.offset().top + window.innerHeight * 0.5) {
            _gsap.default.to(_this.$finalDesktopContent, 0.5, {
              opacity: 1,
              y: 0
            });
          }
      ...
      if (window.innerWidth <= 768) {
        ...
        $(window).on('scroll', function () {
          if (window.pageYOffset > _this.$designMobileSection.offset().top - window.innerHeight * 0.65 && window.pageYOffset < _this.$designMobileSection.offset().top + window.innerHeight * 0.5) {
            _this.mobileDesignTimeline.play();
          }

          if (window.pageYOffset > _this.$smartMobileSection.offset().top - window.innerHeight * 0.65 && window.pageYOffset < _this.$smartMobileSection.offset().top + window.innerHeight * 0.5) {
            _this.mobileSmartTimeline.play();
          }

          if (window.pageYOffset > _this.$performanceMobileSection.offset().top - window.innerHeight * 0.65 && window.pageYOffset < _this.$performanceMobileSection.offset().top + window.innerHeight * 0.5) {
            _this.mobilePerformanceTimeline.play();
          }

          if (window.pageYOffset > _this.$layoutFinalMobile.offset().top - window.innerHeight * 0.65 && window.pageYOffset < _this.$layoutFinalMobile.offset().top + window.innerHeight * 0.5) {
            _gsap.default.to(_this.$finalMobileContent, 0.5, {
              opacity: 1,
              y: 0
            });
          }
    ...
    key: "BuildDesktopDesignTimeline",
    value: function BuildDesktopDesignTimeline() {
      var _this2 = this;
      ...
      _gsap.default.set(this.$designDesktopLeftIMG, {
        autoAlpha: 0,
        x: 60
      });

      _gsap.default.set(this.$designDesktopCenterIMG, {
        autoAlpha: 0,
        x: -60,
        y: -5,
        scale: 0.98
      ...
      _gsap.default.set(this.$designDesktopRightIMG, {
        autoAlpha: 0,
        x: -60
      });

      _gsap.default.set(this.$designDesktopImgHolder, {
        autoAlpha: 0
      });

      _gsap.default.set(this.$designDesktopLabels, {
        autoAlpha: 0
      });

      _gsap.default.set(this.$designDesktopTitle, {
        autoAlpha: 0,
        y: 30
      });

      this.desktopDesignTimeline = new TimelineMax({
        paused: true
      });
      this.desktopDesignTimeline.add('startDesktopDesignAnimation');
      this.desktopDesignTimeline.add(_gsap.default.to([this.$designDesktopImgHolder, this.$designDesktopTitle], 0.65, {
        autoAlpha: 1,
        y: 0
      }));
      this.desktopDesignTimeline.add(_gsap.default.to(this.$designDesktopCenterIMG, 0.75, {
        autoAlpha: 1,
        x: 0,
        y: 0,
        scale: 1
      }));
      this.desktopDesignTimeline.add(_gsap.default.to([this.$designDesktopRightIMG, this.$designDesktopLeftIMG], 1, {
        autoAlpha: 1,
        x: 0,
        onComplete: function onComplete() {
          _this2.$designDesktopSection.find('.effect-holder img').addClass('animating');
        }
      }), '-=0.4');
      this.desktopDesignTimeline.add(_gsap.default.to(this.$designDesktopLabels, 0.4, {
        autoAlpha: 1,
        ease: _gsap.Power2.easeOut
      }), '-=0.4');
    }
  }, {
    key: "BuildDesktopSmartTimeline",
    value: function BuildDesktopSmartTimeline() {
      var _this3 = this;
      ...
      _gsap.default.set(this.$smartDesktopLeftIMG, {
        autoAlpha: 0,
        x: 60
      });

      _gsap.default.set(this.$smartDesktopCenterIMG, {
        autoAlpha: 0,
        y: 35,
        scale: 0.8
      });

      _gsap.default.set(this.$smartDesktopRightIMG, {
        autoAlpha: 0,
        x: -60
      });

      _gsap.default.set(this.$smartDesktopImgHolder, {
        autoAlpha: 0
      });

      _gsap.default.set(this.$smartDesktopLabels, {
        autoAlpha: 0
      });

      _gsap.default.set(this.$smartDesktopTitle, {
        autoAlpha: 0,
        y: 30
      });

      this.desktopSmartTimeline = new TimelineMax({
        paused: true
      });
      this.desktopSmartTimeline.add('startDesktopDesignAnimation');
      this.desktopSmartTimeline.add(_gsap.default.to([this.$smartDesktopImgHolder, this.$smartDesktopTitle], 0.65, {
        autoAlpha: 1,
        y: 0
      }));
      this.desktopSmartTimeline.add([_gsap.default.to(this.$smartDesktopCenterIMG, 1, {
        autoAlpha: 1,
        y: 0,
        scale: 1,
        onComplete: function onComplete() {
          _this3.$smartDesktopSection.find('.center .pin-holder img').addClass('animating');
        }
      }), _gsap.default.to([this.$smartDesktopRightIMG, this.$smartDesktopLeftIMG], 1, {
        autoAlpha: 1,
        x: 0
      })]);
      this.desktopSmartTimeline.add(_gsap.default.to(this.$smartDesktopLabels, 0.4, {
        autoAlpha: 1,
        ease: _gsap.Power2.easeOut
      }), '-=0.4');
    }
  }, {
    key: "BuildDesktopPerformanceTimeline",
    value: function BuildDesktopPerformanceTimeline() {
      ...
      _gsap.default.set(this.$performanceDesktopLeftIMG, {
        autoAlpha: 0,
        x: -60
      });

      _gsap.default.set(this.$performanceDesktopCenterIMG, {
        autoAlpha: 0,
        y: -35
      });

      _gsap.default.set(this.$performanceDesktopRightIMG, {
        autoAlpha: 0,
        x: 60
      });

      _gsap.default.set(this.$performanceDesktopImgHolder, {
        autoAlpha: 0
      });

      _gsap.default.set(this.$performanceDesktopLabels, {
        autoAlpha: 0
      });

      _gsap.default.set(this.$performanceDesktopTitle, {
        autoAlpha: 0,
        y: 30
      });

      this.desktopPerformanceTimeline = new TimelineMax({
        paused: true
      });
      this.desktopPerformanceTimeline.add('startDesktopDesignAnimation');
      this.desktopPerformanceTimeline.add(_gsap.default.to([this.$performanceDesktopImgHolder, this.$performanceDesktopTitle], 0.65, {
        autoAlpha: 1,
        y: 0
      }));
      this.desktopPerformanceTimeline.add([_gsap.default.to(this.$performanceDesktopCenterIMG, 1, {
        autoAlpha: 1,
        y: 0
      }), _gsap.default.to([this.$performanceDesktopRightIMG, this.$performanceDesktopLeftIMG], 1, {
        autoAlpha: 1,
        x: 0
      })]);
      this.desktopPerformanceTimeline.add(_gsap.default.to(this.$performanceDesktopLabels, 0.4, {
        autoAlpha: 1,
        ease: _gsap.Power2.easeOut
      }), '-=0.4');
    }
  }, {
    key: "SetupDesktopFinalPage",
    value: function SetupDesktopFinalPage() {
      this.$finalDesktopContent = this.$layoutFinal.find('.main-content');

      _gsap.default.set(this.$finalDesktopContent, {
        opacity: 0,
        y: 40
      });
    }
    ...
    key: "BuildMobileDesignTimeline",
    value: function BuildMobileDesignTimeline() {
      var _this4 = this;
      ...
      _gsap.default.set(this.$designMobileTitle, {
        opacity: 0,
        y: window.innerHeight * 0.02
      });

      _gsap.default.set(this.$designMobileCenter, {
        opacity: 0,
        scaleY: 0.4
      });

      _gsap.default.set(this.$designMobileCenterIMG, {
        opacity: 0,
        x: -(window.innerHeight * 0.05)
      });

      _gsap.default.set(this.$designMobileLeftIMG, {
        opacity: 0,
        x: window.innerWidth * 0.075
      });

      _gsap.default.set(this.$designMobileRightIMG, {
        opacity: 0,
        x: -(window.innerWidth * 0.075)
      });

      _gsap.default.set(this.$designMobileLabels, {
        opacity: 0
      });

      this.mobileDesignTimeline = new TimelineMax({
        paused: true
      });
      this.mobileDesignTimeline.add('designTimelineMobileStart');
      this.mobileDesignTimeline.add(_gsap.default.to(this.$designMobileTitle, 0.5, {
        opacity: 1,
        y: 1
      }));
      this.mobileDesignTimeline.add(_gsap.default.to(this.$designMobileCenter, 1, {
        opacity: 1,
        scaleY: 1
      }));
      this.mobileDesignTimeline.add(_gsap.default.to(this.$designMobileCenterIMG, 0.75, {
        opacity: 1,
        x: 0
      }), '-=0.1');
      this.mobileDesignTimeline.add('centerFinished');
      this.mobileDesignTimeline.add([_gsap.default.to([this.$designMobileLeftIMG, this.$designMobileRightIMG], 0.75, {
        opacity: 1,
        x: 0,
        onComplete: function onComplete() {
          _this4.$designMobileRight.find('.effect-holder img').addClass('animating');
        }
      })], '-=0.3');
      this.mobileDesignTimeline.add('sideImageFinished');
      this.mobileDesignTimeline.add(_gsap.default.to(this.$designMobileLabels, 0.3, {
        opacity: 1
      }), '-=0.4');
    }
  }, {
    key: "BuildMobileSmartTimeline",
    value: function BuildMobileSmartTimeline() {
      var _this5 = this;
      ...
      _gsap.default.set(this.$smartMobileTitle, {
        opacity: 0,
        y: window.innerHeight * 0.02
      });

      _gsap.default.set(this.$smartMobileCenter, {
        opacity: 0,
        scaleY: 0.4
      });

      _gsap.default.set(this.$smartMobileCenterIMG, {
        opacity: 0,
        y: window.innerHeight * 0.02,
        scale: 1.3
      });

      _gsap.default.set(this.$smartMobileLeftIMG, {
        opacity: 0,
        x: window.innerWidth * 0.075
      });

      _gsap.default.set(this.$smartMobileRightIMG, {
        opacity: 0,
        x: -(window.innerWidth * 0.075)
      });

      _gsap.default.set(this.$smartMobileLabels, {
        opacity: 0
      });

      this.mobileSmartTimeline = new TimelineMax({
        paused: true
      });
      this.mobileSmartTimeline.add('smartTimelineMobileStart');
      this.mobileSmartTimeline.add(_gsap.default.to(this.$smartMobileTitle, 0.5, {
        opacity: 1,
        y: 1
      }));
      this.mobileSmartTimeline.add(_gsap.default.to(this.$smartMobileCenter, 1, {
        opacity: 1,
        scaleY: 1
      }));
      this.mobileSmartTimeline.add(_gsap.default.to(this.$smartMobileCenterIMG, 0.75, {
        opacity: 1,
        scale: 1,
        y: 0,
        onComplete: function onComplete() {
          _this5.$smartMobileCenter.find('.pin-holder img').addClass('animating');
        }
      }), '-=0.3');
      this.mobileSmartTimeline.add('centerFinished');
      this.mobileSmartTimeline.add([_gsap.default.to([this.$smartMobileLeftIMG, this.$smartMobileRightIMG], 0.75, {
        opacity: 1,
        x: 0
      })], '-=0.3');
      this.mobileSmartTimeline.add('sideImageFinished');
      this.mobileSmartTimeline.add(_gsap.default.to(this.$smartMobileLabels, 0.3, {
        opacity: 1
      }), '-=0.4');
    }
  }, {
    key: "BuildMobilePerformanceTimeline",
    value: function BuildMobilePerformanceTimeline() {
      var _this6 = this;
      ...
      _gsap.default.set(this.$performanceMobileTitle, {
        opacity: 0,
        y: window.innerHeight * 0.02
      });

      _gsap.default.set(this.$performanceMobileCenter, {
        opacity: 0,
        scaleY: 0.4
      });

      _gsap.default.set(this.$performanceMobileCenterIMG, {
        opacity: 0,
        y: window.innerHeight * 0.015,
        x: -(window.innerHeight * 0.075)
      });

      _gsap.default.set(this.$performanceMobileLeftIMG, {
        opacity: 0,
        y: -(window.innerHeight * 0.025)
      });

      _gsap.default.set(this.$performanceMobileRightIMG, {
        opacity: 0,
        x: -(window.innerWidth * 0.075)
      });

      _gsap.default.set(this.$performanceMobileLabels, {
        opacity: 0
      });

      this.mobilePerformanceTimeline = new TimelineMax({
        paused: true
      });
      this.mobilePerformanceTimeline.add('performanceTimelineMobileStart');
      this.mobilePerformanceTimeline.add(_gsap.default.to(this.$performanceMobileTitle, 0.5, {
        opacity: 1,
        y: 1
      }));
      this.mobilePerformanceTimeline.add(_gsap.default.to(this.$performanceMobileCenter, 1, {
        opacity: 1,
        scaleY: 1
      }));
      this.mobilePerformanceTimeline.add(_gsap.default.to(this.$performanceMobileCenterIMG, 0.75, {
        opacity: 1,
        x: 0,
        y: 0,
        onComplete: function onComplete() {
          _this6.$performanceMobileCenter.find('.engine-holder img').addClass('animating');
        }
      }), '-=0.3');
      this.mobilePerformanceTimeline.add('centerFinished');
      this.mobilePerformanceTimeline.add([_gsap.default.to([this.$performanceMobileLeftIMG, this.$performanceMobileRightIMG], 0.75, {
        opacity: 1,
        x: 0,
        y: 0,
        onComplete: function onComplete() {
          _this6.$performanceMobileLeft.find('.effect-holder img').addClass('animating');
        }
      })], '-=0.3');
      this.mobilePerformanceTimeline.add('sideImageFinished');
      this.mobilePerformanceTimeline.add(_gsap.default.to(this.$performanceMobileLabels, 0.3, {
        opacity: 1
      }), '-=0.4');
    }
  }, {
    key: "SetupMobileFinalPage",
    value: function SetupMobileFinalPage() {
      this.$finalMobileContent = this.$layoutFinalMobile.find('.main-content');

      _gsap.default.set(this.$finalMobileContent, {
        opacity: 0,
        y: 40
      });
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweenLite__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TweenMaxBase__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CSSPlugin__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__AttrPlugin__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__RoundPropsPlugin__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__DirectionalRotationPlugin__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__TimelineLite__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__TimelineMax__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__BezierPlugin__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__EasePack__ = __webpack_require__(9);
...
function () {
  ...
  function PrizeSection() {
    _classCallCheck(this, PrizeSection);
  ...
  _createClass(PrizeSection, [{
    ...
    key: "SetupPrizeDetail",
    value: function SetupPrizeDetail() {
      var _this = this;
      ...
      this.$subContent = this.$prizeSection.find('.prize-list-layout .right-prize, .prize-list-layout .left-prize, .prize-list-layout .center-prize .detail');
      this.$checkGameRule = this.$prizeSection.find('.cta-holder');

      _gsap.default.set(this.$prizePhoneImage, {
        opacity: 0
      });
      ...
      _gsap.default.set(this.$prizeTitle, {
        opacity: 0,
        y: 30
      });

      _gsap.default.set([this.$subContent, this.$checkGameRule], {
        opacity: 0,
        y: 20
      });

      this.prizeTimeline = new TimelineMax({
        paused: true
      ...
      this.prizeTimeline.add([_gsap.default.to(this.$liveImage, 1.5, {
        scale: 1.06,
        delay: 0.15
      })]);
      this.prizeTimeline.add([_gsap.default.to(this.$liveImage, 0.65, {
        scale: 1,
        opacity: 0
      }), _gsap.default.to(this.$prizePhoneImage, 0.725, {
        opacity: 1,
        scale: 1
      })]);
      this.prizeTimeline.add('phoneShowed');
      this.prizeTimeline.add(_gsap.default.to(this.$prizeTitle, 0.75, {
        opacity: 1,
        y: 0,
        ease: _gsap.Power2.easeOut
      }));
      this.prizeTimeline.add(_gsap.default.to(this.$subContent, 0.5, {
        opacity: 1,
        y: 0
      }), '-=0.2');
      this.prizeTimeline.add(_gsap.default.to(this.$checkGameRule, 0.5, {
        opacity: 1,
        y: 0
      }), '-=0.1');
      this.prizeTimeline.add('animationEnd');
      $(window).on('scroll', function (e) {
        var anchor = _this.$prizeSection.offset().top;

        var windowHeight = window.innerHeight;

        if (anchor > 0 && window.pageYOffset > anchor - windowHeight * 0.2 && window.pageYOffset < anchor + windowHeight * 1) {
          _this.prizeTimeline.tweenTo('animationEnd');
  ...
  _createClass(Banner, [{
    ...
    value: function bindEvents() {
      ...
      setTimeout(function () {
        ...
        _this.timelineBanner.play();
      }, 1250); // Banner Section Setup
    ...
    key: "SetupBannerSection",
    value: function SetupBannerSection() {
      var _this2 = this;
      ...
      TweenMax.set(this.$bannerBikeImage, {
        opacity: 0,
        x: -40
      });
      TweenMax.set(this.$bannerTitleImage, {
        opacity: 0
      });
      TweenMax.set([this.$bannerReleaseDay, this.$bannerClockContainer, this.$bannerActionHolder], {
        opacity: 0,
        y: 15
      });
      ...
      this.timelineBanner = new TimelineMax({
        paused: true,
        onComplete: function onComplete() {
          _this2.timelineSubBanner.play();
        }
      });
      this.timelineBanner.add(TweenMax.to(this.$bannerBikeImage, 1, {
        opacity: 1,
        x: 0,
        delay: 0.25
      }));
      this.timelineBanner.add(TweenMax.to(this.$bannerTitleImage, 0.55, {
        opacity: 1
      }), '-=0.1');
      this.timelineBanner.add(TweenMax.to([this.$bannerReleaseDay, this.$bannerClockContainer, this.$bannerActionHolder], 0.5, {
        opacity: 1,
        y: 0
      }), '+=0.35');
      /* Banner Sub Timeline */
      ...
      this.timelineSubBanner = new TimelineMax({
        paused: true,
        repeat: -1
      }); // Animation Start

      this.timelineSubBanner.add('bikeBannerStart');
      this.timelineSubBanner.add(TweenMax.to(this.$wheelImage, 0.75, {
        opacity: 0,
        x: 80,
        delay: 2,
        onComplete: function onComplete() {
          TweenMax.set(_this2.$wheelImage, {
            opacity: 0,
            x: -80.
          });
        }
      }));
      this.timelineSubBanner.add('wheelFinish'); // Light 1 Show Up

      this.timelineSubBanner.add(TweenMax.to(this.$lightImage, 1.2, {
        opacity: 1,
        y: 0,
        scale: 1,
      ...
      this.timelineSubBanner.add(TweenMax.to(this.$lightImage, 0.75, {
        opacity: 0,
        y: 3,
        scale: 1.1,
        delay: 2
      }));
      this.timelineSubBanner.add('light1Finish'); // Liune 2 Showup

      this.timelineSubBanner.add(TweenMax.to(this.$mainLightImage, 1.2, {
        opacity: 1,
        y: 0,
        scale: 1,
        '-webkit-filter': 'brightness(100%)',
      ...
      this.timelineSubBanner.add(TweenMax.to(this.$mainLightImage, 0.75, {
        opacity: 0,
        y: 3,
        scale: 1.1,
        delay: 2
      }));
      this.timelineSubBanner.add('light2Finish'); // Repeat The Progress With Wheel Image

      this.timelineSubBanner.add(TweenMax.to(this.$wheelImage, 1.2, {
        opacity: 1,
        x: 0,
        delay: 0.1
      }));
...
function () {
  ...
  _createClass(Home, [{
    ...
    value: function bindEvents() {
      ...
      _gsap.TweenMax.to(this.$progressCircleMinutes, 60 - this.remainTime.currentSecond, {
        strokeDashoffset: this.CIRCLE_LENGTH,
        ease: Linear.easeNone,
        onComplete: function onComplete() {
          _this.UpdateClockValue(); // Start looping and update 2 other clock


          _gsap.TweenMax.set(_this.$progressCircleMinutes, {
            strokeDasharray: _this.CIRCLE_LENGTH,
            strokeDashoffset: 0
          });

          _gsap.TweenMax.to(_this.$progressCircleMinutes, 60, {
            strokeDashoffset: _this.CIRCLE_LENGTH,
            repeat: -1,
            yoyo: false,
            ease: Linear.easeNone,
            onRepeat: _this.UpdateClockValue.bind(_this)
          });
        }
      }); // Minutes Run


      _gsap.TweenMax.to(this.$progressCircleHours, 3600 - this.remainTime.currentMins * 60, {
        strokeDashoffset: this.CIRCLE_LENGTH,
        ease: Linear.easeNone,
        onComplete: function onComplete() {
          // Start looping and update 2 other clock
          _gsap.TweenMax.set(_this.$progressCircleHours, {
            strokeDasharray: _this.CIRCLE_LENGTH,
            strokeDashoffset: 0
          });

          _gsap.TweenMax.to(_this.$progressCircleHours, 3600, {
            strokeDashoffset: _this.CIRCLE_LENGTH,
            repeat: -1,
            yoyo: false,
            ease: Linear.easeNone
      ...
      _gsap.TweenMax.to(this.$progressCircleDays, 86400 - this.remainTime.currentHour * 3600, {
        strokeDashoffset: this.CIRCLE_LENGTH,
        ease: Linear.easeNone,
        onComplete: function onComplete() {
          // Start looping and update 2 other clock
          _gsap.TweenMax.set(_this.$progressCircleDays, {
            strokeDasharray: _this.CIRCLE_LENGTH,
            strokeDashoffset: 0
          });

          _gsap.TweenMax.to(_this.$progressCircleDays, 3600, {
            strokeDashoffset: _this.CIRCLE_LENGTH,
            repeat: -1,
            yoyo: false,
            ease: Linear.easeNone
    ...
    key: "SetupHomePage",
    value: function SetupHomePage() {
      console.log('SetupHomePage Was Called');
    }
  }, {
    key: "UpdateClockValue",
    value: function UpdateClockValue() {
