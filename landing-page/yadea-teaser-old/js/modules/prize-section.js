...
export default class PrizeSection {
    ...
    SetupPrizeDetail(){
        ...
        this.prizeTimeline.add([
            TweenMax.to(this.$liveImage, 1.5,{scale: 1.1, delay: 0.15})
        ]);
        this.prizeTimeline.add([
            TweenMax.to(this.$liveImage, 0.32,{scale: 1, opacity: 0}),
            TweenMax.to(this.$prizePhoneImage, 0.32, {opacity: 1, scale: 1})
        ]);
