...
<head>
  ...
  <link rel="stylesheet" href="<?php echo get_theme_file_uri('landing-page/yadea-g5/css/vendors/bootstrap.min.css'); ?>">
...
<style>
  .fb_dialog.fb_customer_chat_bubble_animated_no_badge{
    -webkit-transform: translate(5%, 27%) scale(.85);
    transform: translate(5%, 27%) scale(.85);
  }
...
<div class="page-wrapper" id="yadea-g5-page">
  ...
  <section class="yadea-g5-banner" id="yadea-g5-banner">
    ...
    <div class="banner-bg">
      ...
      <img draggable="false" src="<?php echo get_theme_file_uri('landing-page/yadea-g5/img/g5/banner-g5-mb.jpg'); ?>" class="mb-show">
    </div>
    ...
    <div class="banner-content">
      ...
      <!-- Tra gop content -->
      <div class="tra-gop-img">
        <div class="img-holder">
          <img src="<?php echo get_theme_file_uri('landing-page/yadea-g5/img/g5/tra-gop.png'); ?>"
        </div>
        <p class="tragop-line1">Từ 15.12.2019 - 31-01-2020</p>
        <p class="tragop-line2 open-tragop-modal">* Chi tiết gói trả góp</p>
      </div>
    </div>
  </section>
  <!-- Section 1 - Banner -->
  ...
  <div class="feature-group group-1" id="g5-feature-group-1">
    ...
    <section class="g5-leading-section" id="g5-leading-section">
      <div class="context-block white">
        ...
        <p class="feature-content">
          Không rườm rà, không cầu kỳ, các đường nét thiết kế phóng khoáng, tinh tế, mang đậm màu sắc của sự tự do. Lấy cảm hứng từ <br>
          phong cách tối giản, thân xe là sự kết hợp hoàn hảo của những đường thẳng cứng cáp và đường cong mềm mại, tạo khối gọn gàng,<br>
    ...
    <section class="g5-autoplay-intro-section" id="g5-autoplay-intro-section">
      ...
      <video width="100%" autobuffer="" autoplay="" muted="" loop="" playsinline="">
        <source src="<?php echo get_theme_file_uri('landing-page/yadea-g5/video/intro-g5.mp4'); ?>" type="video/mp4">
      </video>
    </section>
    <!-- Section Intro By Auto Play -->
    ...
    <section class="g5-led-section" id="g5-led-section">
      <div class="context-block white">
        ...
        <p class="feature-content">
          ...
          trội, bền bỉ theo thời gian, tiết kiệm năng lượng hiệu quả. Dù đi qua ngày nắng chói chang hay đêm đen tối mịt, YADEA G5 của bạn vẫn thật nổi bật <br>
          và phong cách
        </p>
      </div>
  ...
  <div class="feature-group group-2" id="g5-feature-group-2">
    ...
    <section class="g5-driving-mode-section" id="g5-driving-mode-section">
      ...
      <div class="context-block white">
        ...
        <p class="feature-content">
          YADEA G5 có 2 chế độ lái POWER và ECO. Nếu muốn xe chạy đầm và tiết kiệm năng lượng, hãy bật chế độ ECO. Nếu<br>
      ...
      <div class="effect-holder">
        <div class="drive-mode-options">
          ...
          <div class="mode-specs">
            <span class="mode-specs-detail sport-detail">Vận tốc tối đa = 52km/h</span>
  ...
  <div class="feature-group group-3" id="g5-feature-group-3">
    ...
    <section class="g5-lithium-battery-section" id="g5-lithium-battery-section">
      ...
      <div class="context-block white">
        ...
        <p class="feature-content">
          Pin cao cấp, nhỏ gọn với trọng lượng 10,5kg, cho hiệu suất sử dụng cao và bền bỉ. Với 1 lần sạc, YADEA G5 có thể đi <br>
          quãng đường lên tới 65km. Cả ngày mặc sức lượn khắp thành phố mà chẳng lo hết pin
        </p>
      </div>
      <!-- Context Block - END -->
  ...
  <div class="feature-group group-5" id="g5-feature-group-5">
    ...
    <section class="g5-accessory-section" id="g5-accessory-section">
      ...
      <div class="context-block">
        ...
        <p class="feature-content">
          Sau quá trình chọn lọc nguyên vật liệu kỹ lưỡng và sản xuất trên dây chuyền hiện đại, tay lái và càng gắp của YADEA G5 được tạo<br>
            ...
            <div class="content-holder">
              ...
              <div class="thumbnail-holder">
                <a class="news-link-wrapper" style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center"
                  ...
                  <img draggable=false src="<?php echo get_theme_file_uri('landing-page/yadea-g5/img/pr/1.jpg'); ?>">
                </a>
              </div>
            ...
            <div class="content-holder">
              ...
              <div class="thumbnail-holder">
                <a class="news-link-wrapper" style="width: 120%; height: 120%; display: flex; align-items: center; justify-content: center"
                  ...
                  <img draggable=false src="<?php echo get_theme_file_uri('landing-page/yadea-g5/img/pr/2.jpg'); ?>">
                </a>
              </div>
            ...
            <div class="content-holder">
              ...
              <div class="thumbnail-holder">
                <a class="news-link-wrapper" style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center"
                  ...
                  <img draggable=false src="<?php echo get_theme_file_uri('landing-page/yadea-g5/img/pr/3.jpg'); ?>">
                </a>
              </div>
            ...
            <div class="content-holder">
              ...
              <div class="thumbnail-holder">
                <a class="news-link-wrapper" style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center"
                  ...
                  <img draggable=false src="<?php echo get_theme_file_uri('landing-page/yadea-g5/img/pr/4.jpg'); ?>"
  ...
  <section class="product-other-information" id="product-other-information">
    ...
    <div class="info-item right-info">
      ...
      <a class="cta cta-info" href="https://www.youtube.com/playlist?list=PLJ7atRCELoPOAr34VNsbanyxxoHTiXAgk">Video về YADEA G5</a>
    </div>
  ...
  <div class="social-comment" style="padding: 3em 0 4em;">
    ...
    <div class="container small">
      <div class="fb-comments" data-href="https://www.yadeavietnam.vn/yadea-g5" data-width="100%" data-numposts="5"></div>
    </div>
    <!-- Container -->
  </div>
  <!-- Social Comment Section -->
  ...
  <div class="signup-info-modal-dialog">
      ...
      <form class="signup-information-form"
        ...
        <div class="submit-holder">
          <button type="submit"
                  ...
                  id="popup-yadea-g5-buynow-signup-btn">
    ...
    <div class="right-content">
      ...
      <a class="right-cta track-this-button"
         id="popup-findstore-yadea-g5-btn"
...
<div class="tra-gop-information-modal">
  ...
  <div class="tragop-dialog">
    ...
    <div class="tragop-main-content">
      ...
      <p class="desc">
        <b>1.</b> Thời gian áp dụng: <b>15/12/2019 – 31/01/2020</b><br>
        <b>2.</b> Sản phẩm áp dụng: <b>YADEA G5</b><br>
        <b>3.</b> Giá sản phẩm: <b>39.990.000VNĐ</b><br>
        <b>4.</b> Màu sản phẩm: <b>Đỏ kim, Xám bạc, Đen tuyền, Trắng sứ</b>
        <b>5.</b> Phạm vi áp dụng: <b>Các đại lý YADEA có ký hợp đồng với Công ty tài chính FE Credit trong thời gian áp
          dụng chương trình.</b>
        <b>6.</b> Nội dung chi tiết:
      ...
      <ul>
        ...
        <li>Sản phẩm xe máy điện YADEA G5 chỉ hỗ trợ gói trả góp 0% khi bán đúng giá sản phẩm niêm yết: 39.990.000 VND</li>
      </ul>
      <p class="desc">
        <b>8.</b> Quy trình mua hàng:<br>
      </p>
      <ul>
      ...
      <p class="desc">
        Mọi thông tin chi tiết và thắc mắc về chương trình, Khách hàng vui lòng liên hệ Hotline 18006959 hoặc để lại bình luận ở cuối trang website.
      </p>
    </div>
  </div>
</div>
