...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(22)(module), __webpack_require__(4)))
...
function () {
  ...
  _createClass(Common, [{
    ...
    value: function BikeColorSliderSetup() {
      ...
      this.$bikeColorSlider.on('beforeChange', function (event, slick, currentSlide, nextSlide) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweenLite__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TimelineLite__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TimelineMax__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__TweenMax__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__CSSPlugin__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__AttrPlugin__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__RoundPropsPlugin__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__DirectionalRotationPlugin__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__BezierPlugin__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__EasePack__ = __webpack_require__(12);
...
var _home = _interopRequireDefault(__webpack_require__(14));
...
var _banner = _interopRequireDefault(__webpack_require__(15));

var _distance = _interopRequireDefault(__webpack_require__(16));

var _light = _interopRequireDefault(__webpack_require__(17));

var _featureMixed = _interopRequireDefault(__webpack_require__(18));

var _featureMixed2 = _interopRequireDefault(__webpack_require__(19));

var _featureMixed3 = _interopRequireDefault(__webpack_require__(20));

var _antiThief = _interopRequireDefault(__webpack_require__(21));

var _waterResistance = _interopRequireDefault(__webpack_require__(25));

var _accessories = _interopRequireDefault(__webpack_require__(26));

var _feature = _interopRequireDefault(__webpack_require__(27));
...
function () {
  ...
  function Home() {
    ...
    window.ulikeListener = new _utils.pageListener();
    ...
    var light = new _light.default();
    var mixedFeature1 = new _featureMixed.default();
    var mixedFeature2 = new _featureMixed2.default();
    var bikeController = new _bikeController.default();
    var mixedFeature3 = new _featureMixed3.default();
    var antiThief = new _antiThief.default();
    var waterResistance = new _waterResistance.default();
...
function () {
  ...
  _createClass(Banner, [{
    ...
    value: function BannerSetup() {
      ...
      this.$bikeFeature = this.$bannerSection.find('.banner-feature'); // Init State For
      ...
      TweenMax.set(this.$bikeName, {
        opacity: 0,
        x: -this.moveDistance,
        y: -moveDistance * this.angleRatio
      });
      TweenMax.set(this.$bikeSlogan, {
        opacity: 0,
        x: this.moveDistance,
        y: moveDistance * this.angleRatio
      });
      TweenMax.set(this.$bikeFeature, {
        opacity: 0,
        y: moveDistance * 0.05
      }); // Banner Timeline
      ...
      this.bannerTimeline.to(this.$bikeImage, 1, {
        opacity: 1,
        x: 0,
        ease: Power3.easeOut
      });
      this.bannerTimeline.to([this.$bikeName, this.$bikeSlogan], 0.85, {
        opacity: 1,
        x: 0,
        y: 0,
        ease: Power3.easeOut
      }, '-=0.5');
      this.bannerTimeline.to(this.$bikeFeature, 0.35, {
        opacity: 1,
        y: 0
      }, '-=0.25');
    }
    ...
    value: function BannerInit() {
      ...
      ulikeListener.on('page-start', function () {
...
function () {
  ...
  _createClass(Distance, [{
    ...
    key: "DistanceSetup",
    value: function DistanceSetup() {
      this.$distanceSection = $('.section-distance');
      this.$distanceHead = this.$distanceSection.find('.heading-img');
      this.$distanceContext = this.$distanceSection.find('.context-layout'); // Init State For

      moveDistance = window.innerWidth * 0.1;
      TweenMax.set(this.$distanceHead, {
        opacity: 0,
        y: moveDistance / 5
      });
      TweenMax.set(this.$distanceContext, {
        opacity: 0,
        y: moveDistance / 5
      }); // Banner Timeline

      this.distanceTimeline = new TimelineMax({
        paused: true
      }); // Animation Timeline Build

      this.distanceTimeline.add('anim-start');
      this.distanceTimeline.to(this.$distanceHead, 0.75, {
        opacity: 1,
        y: 0,
        ease: Power2.easeOut
      });
      this.distanceTimeline.to(this.$distanceContext, 1, {
        opacity: 1,
        y: 0,
        ease: Power2.easeOut
      }, '-=0.25');
    ...
    key: "DistanceInit",
    value: function DistanceInit() {
      var _this = this;

      ulikeListener.on('distance-anim', function () {
        _this.distanceTimeline.play();
      });
    }
  }]);
...
function () {
  ...
  _createClass(Light, [{
    ...
    value: function LightSetup() {
      ...
      this.$ledImg = this.$effectHolder.find('.led-effect'); // Init State For Light Section

      TweenMax.set(this.$mainContent, {
        opacity: 0,
        y: moveDistance / 5
      });
      TweenMax.set(this.$effectHolder, {
        opacity: 0,
        scale: 1
      });
      ...
      this.lightTimeline.to(this.$effectHolder, 0.5, {
        opacity: 1
      });
      this.lightTimeline.add([TweenMax.to(this.$bikeImg, 0.85, {
        '-webkit-filter': 'brightness(1)',
        ease: Power4.easeIn
      }), TweenMax.to(this.$ledImg, 0.75, {
        opacity: 1,
        ease: Power4.easeIn
      })], '-=0.15');

      if (!isMobile) {
        this.lightTimeline.to(this.$effectHolder, 1.65, {
          scale: 0.38,
      ...
      this.lightTimeline.to(this.$mainContent, 0.65, {
        opacity: 1,
        y: 0
      }, '-=0.5');
    }
    ...
    value: function LightInit() {
      ...
      ulikeListener.on('light-anim', function () {
        _this2.lightTimeline.play();
      });
    }
  }, {
    key: "LightRepeat",
    value: function LightRepeat() {
      var _this3 = this;

      setTimeout(function () {
        _this3.lightRepeatTimeline = new TimelineMax({
          repeat: -1,
          repeatDelay: 5
        });

        _this3.lightRepeatTimeline.to(_this3.$ledImg, 0.25, {
          opacity: 0
        });

        _this3.lightRepeatTimeline.to(_this3.$ledImg, 0.5, {
          opacity: 1,
          ease: Power3.easeIn
        }, '+=1,25');
      }, 4000);
...
function () {
   ...
   *  CONSTRUCTOR
   * =================================== */
  function MixedFeature1() {
    _classCallCheck(this, MixedFeature1);
  ...
  _createClass(MixedFeature1, [{
    ...
    key: "MixedFeature1Setup",
    value: function MixedFeature1Setup() {
      this.$mixed1Section = $('#yadea-ulike-page .feature-mixed-1'); // Mixed Effect And Comfort Section Have The Same Trigger
      // Mixed Elements

      this.$mixedEffectHolder = this.$mixed1Section.find('.mixed-effect');
      this.$mixedLayer = this.$mixedEffectHolder.find('.top-background');
      this.$boundaryElement = this.$mixedEffectHolder.find('.boundary-holder'); // Comfort Elements
      ...
      this.TRIANGLE_LENGTH = 781.02; // Init State

      var mixedLayerHeight = this.$mixedLayer.height() + this.$boundaryElement.height();
      TweenMax.set(this.$mixedLayer, {
        y: -mixedLayerHeight
      });
      TweenMax.set(this.$comfortMainContent, {
        opacity: 0,
        y: moveDistance / 5
      });
      TweenMax.set(this.$comfortEffectHolder, {
        opacity: 0,
        x: -moveDistance / 4
      });
      TweenMax.set(this.$comfortBikeOverlay, {
        opacity: 0
      });
      ...
      TweenMax.set(this.$comfortTriangleDetail, {
        opacity: 0
      }); // Timeline

      this.mixedEffectTimeline = new TimelineMax({
        paused: true
      }); // Timeline Build
      ...
      if (isMobile) {
        TweenMax.to(this.$comfortMainContent, 0.75, {
          y: 0,
          opacity: 1
        });
      }

      this.mixedEffectTimeline.to(this.$mixedLayer, 1.75, {
        y: 0,
        ease: Power4.easeOut
      });
      this.mixedEffectTimeline.to(this.$comfortEffectHolder, 1, {
        x: 0,
        opacity: 1,
        ease: Power3.easeOut
      }, '-=0.75');
      this.mixedEffectTimeline.to(this.$comfortBikeImg, 0.45, {
        opacity: 0
      }, '-=0.25');
      this.mixedEffectTimeline.to(this.$comfortBikeOverlay, 0.45, {
        opacity: 1
      }, '-=0.45');
      this.mixedEffectTimeline.to(this.$comfortTriangleShape, 0.75, {
        strokeDashoffset: 0,
        ease: Linear.easeNone
      });
      this.mixedEffectTimeline.to(this.$comfortTriangleDetail, 0.5, {
        opacity: 1
      }, '+=0.25');

      if (!isMobile) {
        this.mixedEffectTimeline.add([TweenMax.to(this.$comfortEffectHolder, 0.75, {
          x: moveDistance * 1.65,
          ease: Power2.easeOut
        }), TweenMax.to(this.$comfortMainContent, 0.75, {
          y: 0,
    ...
    key: "LedSectionSetup",
    value: function LedSectionSetup() {
      ...
      this.$ledImg = this.$ledEffect.find('.led'); // Init State

      TweenMax.set(this.$ledSection, {
        opacity: 0,
        y: moveDistance / 5
      });
      TweenMax.set(this.$ledImg, {
    ...
    key: "MixedFeature1Init",
    value: function MixedFeature1Init() {
      var _this = this;

      ulikeListener.on('mixed-feature-1-anim', function () {
        _this.mixedEffectTimeline.play();
      });
      ulikeListener.on('led-anim', function () {
        TweenMax.to(_this.$ledSection, 0.5, {
          opacity: 1,
          y: 0,
          onComplete: function onComplete() {
            _this.repeatLedEffect = new TimelineMax({
              repeat: -1,
              repeatDelay: 2
            });

            _this.repeatLedEffect.to(_this.$ledImg, 0.5, {
              opacity: 1,
              ease: Power3.easeIn
            });

            _this.repeatLedEffect.to(_this.$ledImg, 0.35, {
              opacity: 0,
              ease: Power3.easeOut
            }, '+=2');
          }
  ...
  return MixedFeature1;
}();

exports.default = MixedFeature1;
...
function () {
   ...
   *  CONSTRUCTOR
   * =================================== */
  function MixedFeature2() {
    _classCallCheck(this, MixedFeature2);
  ...
  _createClass(MixedFeature2, [{
    ...
    key: "MixedFeature2Setup",
    value: function MixedFeature2Setup() {
      this.$mixed2Section = $('.feature-mixed-2'); // Mixed Elements
      ...
      this.LAYER3_DISTANCE = this.$mixedLayer3.height() + this.$mixedLayer3Boundary.height(); // Design Elements

      this.$designSection = $('.design-feature');
      this.$designMainContent = this.$designSection.find('.main-content');
      this.$designImageList = this.$designSection.find('.images-list'); // Init State

      TweenMax.set(this.$mixedLayer1, {
        y: -this.LAYER1_DISTANCE
      });
      TweenMax.set(this.$mixedLayer2, {
        y: -this.LAYER2_DISTANCE
      });
      TweenMax.set(this.$mixedLayer3, {
        y: -this.LAYER3_DISTANCE
      });
      TweenMax.set(this.$designMainContent, {
        opacity: 0,
        y: moveDistance / 5
      });
      TweenMax.set(this.$designImageList, {
        opacity: 0,
        y: moveDistance / 4
      }); // Timeline

      this.mixed2Timeline = new TimelineMax({
        paused: true
      });
      this.mixed2Timeline.add('anim-start');
      this.mixed2Timeline.add([TweenMax.to(this.$mixedLayer1, 1, {
        y: 0
      }), TweenMax.to(this.$mixedLayer2, 1.75, {
        y: 0,
        delay: 0.25
      }), TweenMax.to(this.$mixedLayer3, 2.5, {
        y: 0,
        delay: 0.75
      })]);
      this.mixed2Timeline.to(this.$designMainContent, 0.5, {
        opacity: 1,
        y: 0
      }, '-=2.5');
      this.mixed2Timeline.to(this.$designImageList, 0.5, {
        opacity: 1,
        y: 0
      }, '-=2.2');
    }
  }, {
    key: "FashionColorSetup",
    value: function FashionColorSetup() {
      this.$colorSection = $('.feature-mixed-2 .colors-feature');
      this.$colorMainContent = this.$colorSection.find('.main-content');
      this.$colorSlider = this.$colorSection.find('.colors-slider-holder'); // Init State
    ...
    value: function ContainerSetup() {
      ...
      this.$containerShadowImg = this.$containerSection.find('.effect-holder .shadow-img'); // Init State

      TweenMax.set(this.$containerMainContent, {
        opacity: 0,
        y: moveDistance / 5
      });
      TweenMax.set(this.$containerBikeImg, {
        opacity: 0,
        x: moveDistance / 4
      });
      TweenMax.set(this.$containerShadowImg, {
        opacity: 0,
        x: 10
      });
    }
    ...
    key: "ChargingSetup",
    value: function ChargingSetup() {
      this.$chargingSection = $('.feature-mixed-2 .charging-feature');
      this.$chargingMainContent = this.$chargingSection.find('.main-content');
      this.$chargingImg = this.$chargingSection.find('.thumbnail'); // Init State

      TweenMax.set(this.$chargingMainContent, {
        opacity: 0,
        y: moveDistance / 5
      });
      TweenMax.set(this.$chargingImg, {
        opacity: 0,
        y: moveDistance / 4
      });
    }
  }, {
    key: "SmartScreenSetup",
    value: function SmartScreenSetup() {
      ...
      this.$smartScreenDetails = this.$smartScreenSection.find('.detail-item'); // Init State

      TweenMax.set(this.$smartScreenMainContent, {
        opacity: 0,
        y: moveDistance / 5
      });
      TweenMax.set(this.$smartScreenImg, {
        opacity: 0,
        y: moveDistance / 4
      });
      TweenMax.set(this.$smartScreenDetails, {
        opacity: 0
      });
    }
  }, {
    key: "MixedFeature2Init",
    value: function MixedFeature2Init() {
      var _this = this;

      ulikeListener.on('mixed-feature-2-anim', function () {
        _this.mixed2Timeline.play();
      });
      ulikeListener.on('fashion-color-anim', function () {
        TweenMax.to(_this.$colorMainContent, 0.5, {
          opacity: 1,
          y: 0
        });
        TweenMax.to(_this.$colorSlider, 0.5, {
          opacity: 1,
          y: 0,
          delay: 0.15
        });
      });
      ulikeListener.on('container-anim', function () {
        TweenMax.to(_this.$containerMainContent, 0.5, {
          opacity: 1,
          y: 0
        });
        TweenMax.to(_this.$containerBikeImg, 0.75, {
          opacity: 1,
          x: 0,
          delay: 0.35
        });
        TweenMax.to(_this.$containerShadowImg, 0.5, {
          opacity: 1,
          x: 0,
          delay: 1.25
        });
      });
      ulikeListener.on('charging-anim', function () {
        TweenMax.to(_this.$chargingMainContent, 0.5, {
          opacity: 1,
          y: 0
        });
        TweenMax.to(_this.$chargingImg, 0.5, {
          opacity: 1,
          y: 0,
          delay: 0.35
        });
      });
      ulikeListener.on('smart-screen-anim', function () {
        TweenMax.to(_this.$smartScreenMainContent, 0.5, {
          opacity: 1,
          y: 0
        });
        TweenMax.to(_this.$smartScreenImg, 0.5, {
          opacity: 1,
          y: 0,
          delay: 0.35
        });
        TweenMax.to(_this.$smartScreenDetails, 0.5, {
          opacity: 1,
          delay: 1
        });
      });
  ...
  return MixedFeature2;
}();

exports.default = MixedFeature2;
...
function () {
  ...
  _createClass(MixedFeature2, [{
    ...
    key: "MixedFeature3Setup",
    value: function MixedFeature3Setup() {
      this.$mixed3Section = $('.feature-mixed-3'); // Mixed Effect Elements
      ...
      TweenMax.set(this.$mixedEffectLayer, {
        y: -this.MIXED_START_POSITION
      ...
      this.$engineMainContent = this.$engineSection.find('.main-content'); // Init State Engine Section

      TweenMax.set(this.$engineMainContent, {
        opacity: 0,
        y: moveDistance / 5
      });
      TweenMax.set(this.$engineImg, {
        opacity: 0,
        x: -moveDistance / 3
      });
      TweenMax.set(this.$engineContext, {
        opacity: 0,
        x: -moveDistance / 5
      }); // Mixed Section Timeline

      this.mixedSection3Timeline = new TimelineMax({
        paused: true
      });
      this.mixedSection3Timeline.add('anim-start');
      this.mixedSection3Timeline.to(this.$mixedEffectLayer, 1, {
        y: 0,
        ease: Power2.easeOut
      });
      this.mixedSection3Timeline.to(this.$engineImg, 1, {
        opacity: 1,
        x: 0,
        ease: Power3.easeOut
      }, '-=0.45');
      this.mixedSection3Timeline.to([this.$engineContext, this.$engineMainContent], 0.5, {
        opacity: 1,
        y: 0,
        x: 0
      }, '-=0.55');
    ...
    key: "MixedFeature3Init",
    value: function MixedFeature3Init() {
      var _this = this;

      ulikeListener.on('mixed-feature-3-anim', function () {
        _this.mixedSection3Timeline.play();
      });
    }
  }]);
...
function () {
   ...
   * =================================== */
  function AntiThief() {
    _classCallCheck(this, AntiThief);
  ...
  _createClass(AntiThief, [{
    ...
    value: function AntiThiefSetup() {
      ...
      this.$soundImg2 = this.$effectHolder.find('.sound-img.sound-2'); // Set Init State

      _TweenMax.TweenMax.set(this.$mainContent, {
        opacity: 0,
        y: moveDistance / 5
      });

      _TweenMax.TweenMax.set(this.$effectHolder, {
        opacity: 0,
        x: -moveDistance / 4
      });

      _TweenMax.TweenMax.set(this.$bikeShadow1, {
        opacity: 0
      });

      _TweenMax.TweenMax.set(this.$bikeShadow2, {
        opacity: 0
      });

      _TweenMax.TweenMax.set([this.$bikeBacklight, this.$bellImg, this.$bellWaveImg, this.$soundImg1, this.$soundImg2], {
        opacity: 0
      });
      ...
      this.appearTimeline = new TimelineMax({
        ...
        onComplete: function onComplete() {
          if (window.innerWidth > 768) {
            _this.DoShadowParallax();
          } else {
            _TweenMax.TweenMax.to(_this.$bikeShadow1, 0.5, {
              opacity: 1,
              x: 8,
              y: 10
            });

            _TweenMax.TweenMax.to(_this.$bikeShadow2, 0.5, {
              opacity: 1,
              x: -10,
              y: -10
            });
          ...
          _this.DoAntiThieftAnimation();
        }
      });
      this.appearTimeline.add(_TweenMax.TweenMax.to(this.$mainContent, 0.5, {
        opacity: 1,
        y: 0
      }));
      this.appearTimeline.add(_TweenMax.TweenMax.to(this.$effectHolder, 0.75, {
        opacity: 1,
        x: 0
      }));
    }
    ...
    key: "AntiThiefInit",
    value: function AntiThiefInit() {
      var _this2 = this;

      ulikeListener.on('anti-thief-anim', function () {
        _this2.appearTimeline.play();
      });
    }
  }, {
    ...
    value: function DoShadowParallax() {
      ...
      _TweenMax.TweenMax.to(this.$bikeShadow1, 0.5, {
        opacity: 1,
        x: 0,
        y: 0
      });

      _TweenMax.TweenMax.to(this.$bikeShadow2, 0.5, {
        opacity: 1,
        x: 0,
        y: 0,
        onComplete: function onComplete() {
          if (window.innerWidth > 767) {
            _this3.$antiThiefSection.on('mousemove', function (e) {
              var coreData = {
                offsetX: e.clientX,
                offsetY: e.clientY,
                core: {
                  x: _this3.$antiThiefSection.width() / 2,
                  y: _this3.$antiThiefSection.height() / 2
                }
              };
              var calculatedData = {
              ...
              _TweenMax.TweenMax.to(_this3.$bikeShadow1, 0.5, {
                x: -calculatedData.xMove,
                y: -calculatedData.yMove
              });

              _TweenMax.TweenMax.to(_this3.$bikeShadow2, 0.5, {
                x: calculatedData.xMove,
                y: calculatedData.yMove
              });
            });
    ...
    key: "DoAntiThieftAnimation",
    value: function DoAntiThieftAnimation() {
      this.antiThiefTimeline = new TimelineMax({
        repeat: -1,
        repeatDelay: 2
      });
      this.antiThiefTimeline.add(_TweenMax.TweenMax.to([this.$bellImg, this.$bikeBacklight], 0.5, {
        opacity: 1
      }));
      this.antiThiefTimeline.add([_TweenMax.TweenMax.to(this.$bellImg, 0.1, {
        rotation: '12deg',
        transformOrigin: '50% 0%'
      }), _TweenMax.TweenMax.to(this.$bellWaveImg, 0.1, {
        scale: '1.05',
        ease: Linear.easeNone,
        opacity: 1
      }), _TweenMax.TweenMax.fromTo(this.$soundImg1, 0.1, {
        opacity: 0,
        scale: 0.75,
        x: 3,
        y: 8
        ...
        y: 3,
        ease: Linear.easeNone
      }), _TweenMax.TweenMax.fromTo(this.$soundImg2, 0.1, {
        opacity: 0,
        scale: 0.75,
        x: -3,
        y: 8
      ...
      this.antiThiefTimeline.add([_TweenMax.TweenMax.to(this.$bellImg, 0.1, {
        ...
        ease: Linear.easeNone,
        opacity: 1
      }), _TweenMax.TweenMax.to(this.$soundImg1, 0.1, {
        opacity: 0.5,
        scale: 0.95,
        x: -2,
        y: -2,
        ease: Linear.easeNone
      }), _TweenMax.TweenMax.to(this.$soundImg2, 0.1, {
        opacity: 0.5,
        scale: 0.95,
        x: 2,
        y: -2,
      ...
      this.antiThiefTimeline.add([_TweenMax.TweenMax.to(this.$bellImg, 0.1, {
        ...
        ease: Linear.easeNone,
        opacity: 0
      }), _TweenMax.TweenMax.to(this.$soundImg1, 0.15, {
        opacity: 0,
        scale: 1.12,
        x: -10,
        y: -14,
        ease: Linear.easeNone
      }), _TweenMax.TweenMax.to(this.$soundImg2, 0.15, {
        opacity: 0,
        scale: 1.12,
        x: 10,
        y: -14,
      ...
      this.antiThiefTimeline.add([_TweenMax.TweenMax.to(this.$bellImg, 0.05, {
        rotation: '0deg',
        transformOrigin: '50% 0%'
      })]);
      this.antiThiefTimeline.add([_TweenMax.TweenMax.to([this.$bellImg, this.$bikeBacklight], 0.5, {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweenLite__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TweenMaxBase__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CSSPlugin__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__AttrPlugin__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__RoundPropsPlugin__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__DirectionalRotationPlugin__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__TimelineLite__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__TimelineMax__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__BezierPlugin__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__EasePack__ = __webpack_require__(12);
...
function () {
  ...
  function WaterResistance() {
    _classCallCheck(this, WaterResistance);
  ...
  _createClass(WaterResistance, [{
    ...
    key: "WaterResistanceSetup",
    value: function WaterResistanceSetup() {
      ...
      this.$waterSplashImg = this.$waterSection.find('.water-splash'); // Init State

      TweenMax.set(this.$waterContent, {
        opacity: 0,
        y: moveDistance / 5
      });
      TweenMax.set(this.$waterEffect, {
        opacity: 0,
        y: -moveDistance / 2
      });
      ...
      this.waterSectionTimeline = new TimelineMax({
        paused: true
      });
      this.waterSectionTimeline.add('anim-start');
      this.waterSectionTimeline.add([TweenMax.to(this.$waterEffect, 1.25, {
        opacity: 1,
        y: 0,
        ease: Power3.easeOut
      ...
      this.waterSectionTimeline.to(this.$waterSplashImg, 0.45, {
        opacity: 1,
        scale: 1,
        y: 0,
    ...
    key: "WaterResistanceInit",
    value: function WaterResistanceInit() {
      var _this = this;

      ulikeListener.on('water-resistance-anim', function () {
        _this.waterSectionTimeline.play();
      });
    }
  }]);
...
exports.default = WaterResistance;
...
function () {
  ...
  _createClass(Accessories, [{
    ...
    key: "AccessoriesSetup",
    value: function AccessoriesSetup() {
      ...
      this.$accessoriesList = this.$accessoriesSection.find('.accessories-list'); // Init State

      TweenMax.set(this.$accessoriesMainContent, {
        opacity: 0,
        y: moveDistance / 5
      });
      TweenMax.set(this.$accessoriesList, {
        opacity: 0,
        y: moveDistance / 4
      });
    }
    ...
    key: "AccessoriesInit",
    value: function AccessoriesInit() {
      var _this = this;

      ulikeListener.on('accessories-anim', function () {
        TweenMax.to(_this.$accessoriesMainContent, 0.5, {
          opacity: 1,
          y: 0
        });
        TweenMax.to(_this.$accessoriesList, 0.75, {
          opacity: 1,
          y: 0,
          delay: 0.35
        });
...
function () {
  ...
  _createClass(Features, [{
    ...
    key: "FeaturesSetup",
    value: function FeaturesSetup() {
      this.$featureSection = $('#yadea-ulike-page .section-features');
      this.$featureMainContent = this.$featureSection.find('.main-content');
      this.$featureList = this.$featureSection.find('.feature-list'); // Init State

      TweenMax.set(this.$featureMainContent, {
        opacity: 0,
        y: moveDistance / 5
      });
      TweenMax.set(this.$featureList, {
        opacity: 0,
        y: moveDistance / 4
      });
    }
    ...
    key: "FeatureInit",
    value: function FeatureInit() {
      var _this = this;

      ulikeListener.on('features-anim', function () {
        TweenMax.to(_this.$featureMainContent, 0.5, {
          opacity: 1,
          y: 0
        });
        TweenMax.to(_this.$featureList, 0.75, {
          opacity: 1,
          y: 0,
          delay: 0.35
        });
...
function () {
  ...
  function BikeController() {
    _classCallCheck(this, BikeController);
  ...
  _createClass(BikeController, [{
    ...
    key: "BikeControllerSetup",
    value: function BikeControllerSetup() {
      ...
      this.$bikeControllerDetail = this.$bikeControllerEffect.find('.controller-context'); // Init State

      TweenMax.set(this.$bikeControllerContent, {
        opacity: 0,
        y: moveDistance / 5
      });
      TweenMax.set(this.$bikeControllerEffect, {
        opacity: 0,
        y: moveDistance / 4
      });
      TweenMax.set(this.$bikeControllerDetail, {
        opacity: 0
      }); // Bike Controller Timeline

      this.bikeControllerTimeline = new TimelineMax({
        paused: true
      }); // Bike Controller Timeline build

      this.bikeControllerTimeline.add('anim-start');
      this.bikeControllerTimeline.to(this.$bikeControllerContent, 0.5, {
        opacity: 1,
        y: 0
      });
      this.bikeControllerTimeline.to(this.$bikeControllerEffect, 1.25, {
        opacity: 1,
        y: 0,
        ease: Power3.easeOut
      }, '-=0.15');
      this.bikeControllerTimeline.to(this.$bikeControllerDetail, 0.35, {
        opacity: 1
      }, '-=0.5');
    }
  }, {
    key: "BikeControllerInit",
    value: function BikeControllerInit() {
      var _this = this;

      ulikeListener.on('controller-anim', function () {
        _this.bikeControllerTimeline.play();
      });
    }
  }]);
...
function () {
  ...
  function ColorFeature() {
    _classCallCheck(this, ColorFeature);
  ...
  _createClass(ColorFeature, [{
    ...
    key: "ColorFeatureSliderSetup",
    value: function ColorFeatureSliderSetup() {
      var _this = this;
      ...
      $('.colors-slider-holder .colors-indicator .color-item').on('click', function (e) {
