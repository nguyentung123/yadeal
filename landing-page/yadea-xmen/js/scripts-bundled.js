...
var _home = _interopRequireDefault(__webpack_require__(16));

var _lazyLoadVideo = _interopRequireDefault(__webpack_require__(34));
...
var _youtubePlayer = _interopRequireDefault(__webpack_require__(3));
...
var _sister = __webpack_require__(4);

var _sister2 = _interopRequireDefault(_sister);

var _loadYouTubeIframeApi = __webpack_require__(5);

var _loadYouTubeIframeApi2 = _interopRequireDefault(_loadYouTubeIframeApi);

var _YouTubePlayer = __webpack_require__(7);
...
var _functionNames = __webpack_require__(12);

var _functionNames2 = _interopRequireDefault(_functionNames);

var _eventNames = __webpack_require__(13);

var _eventNames2 = _interopRequireDefault(_eventNames);

var _FunctionStateMap = __webpack_require__(14);
...
var _PlayerStates = __webpack_require__(15);
...
var _TweenMax = __webpack_require__(17);

var _scrollOut = _interopRequireDefault(__webpack_require__(19));

var _utils = __webpack_require__(20);

var _signupInfo = _interopRequireDefault(__webpack_require__(21));

var _banner = _interopRequireDefault(__webpack_require__(22));

var _intro = _interopRequireDefault(__webpack_require__(23));

var _color = _interopRequireDefault(__webpack_require__(24));

var _battery = _interopRequireDefault(__webpack_require__(25));

var _power = _interopRequireDefault(__webpack_require__(26));

var _maintain = _interopRequireDefault(__webpack_require__(29));

var _compare = _interopRequireDefault(__webpack_require__(30));

var _brake = _interopRequireDefault(__webpack_require__(31));

var _distance = _interopRequireDefault(__webpack_require__(32));

var _smartkey = _interopRequireDefault(__webpack_require__(33));
...
function () {
  ...
  function Home() {
    ...
    window.yadeaXMenListener = new _utils.pageListener();
    window.TweenMax = _TweenMax.TweenMax;
    window.IS_MOBILE = window.innerWidth <= 768; // Sections
    ...
    var battery = new _battery.default();
    var power = new _power.default();
    var maintainance = new _maintain.default();
    var compare = new _compare.default();
    var brake = new _brake.default();
    var distance = new _distance.default();
    var smartKey = new _smartkey.default();
    this.Triggered = {};
    this.bindEvents();
  }
  /* ===================================
    ...
    value: function ScrolloutSetup() {
      ...
      (0, _scrollOut.default)({
        onShown: function onShown(el) {
          ...
          if (!_this.Triggered["".concat(elementID)]) {
            _this.Triggered["".concat(elementID)] = true;
            yadeaXMenListener.emit("".concat(elementID, "-anim"));
          }
        },
        threshold: 0.225
      });
...
function () {
  ...
  function Banner() {
    ...
    this.DISTANCE_Y = window.innerWidth * 0.05; // Elements Variables
  ...
  _createClass(Banner, [{
    ...
    value: function bindEvents() {
      ...
      this.InitSection();
      yadeaXMenListener.on("yadea-xmen-banner-anim", function () {
        _this.starterTimeline.play();
      });
    }
    /* ===================================
     *  METHODS
    ...
    value: function InitSection() {
      // Init State
      TweenMax.set(this.$BannerBg, {
        autoAlpha: 0
      });
      TweenMax.set(this.$BannerSaleDetailInfo, {
        y: this.DISTANCE_Y * 0.25,
        autoAlpha: 0
      });
      TweenMax.set(this.$BannerSaleDetailLogo, {
        autoAlpha: 0
      });
      TweenMax.set(this.$BannerSaleDetailCTA, {
        autoAlpha: 0,
        y: this.DISTANCE_Y * 0.25
      }); // Build Timeline

      this.starterTimeline.to(this.$BannerBg, 0.6, {
        autoAlpha: 1
      });
      this.starterTimeline.to(this.$BannerSaleDetailLogo, 0.6, {
        autoAlpha: 1
      }, "-=0.2");
      this.starterTimeline.staggerTo(this.$BannerSaleDetailInfo, 0.4, {
        autoAlpha: 1,
        y: 0
      }, 0.15, "-=0.6");
      this.starterTimeline.to(this.$BannerSaleDetailCTA, 0.5, {
        autoAlpha: 1,
        y: 0
      }, "-=0.2");
    }
...
function () {
  ...
  function Intro() {
    ...
    this.blockInteraction = true; // Elements Variables

    this.$IntroSection = $("#yadea-xmen-intro");
    this.$CoverOverlay = this.$IntroSection.find(".cover-layer"); // First Layer
    ...
    this.$FirstLayer_Controller = this.$IntroFirstLayer.find(".layer-controller"); // Detail Layer

    this.$IntroDetailLayer = this.$IntroSection.find(".layer-controller"); // X5 Layer Elements
    ...
    this.$IntroDetail_X5_Images_Items = this.$IntroDetail_X5_Images.find(".image-block .img-item"); // XMEN Layer Elements
    ...
    this.$IntroDetail_XMEN_Images_Items = this.$IntroDetail_XMEN_Images.find(".image-block .img-item"); // Switch Page Button
  ...
  _createClass(Intro, [{
    ...
    value: function bindEvents() {
      ...
      this.InitSection();
      yadeaXMenListener.on("yadea-xmen-intro-anim", function () {
        _this.MainPageIn();
      });
    ...
    value: function SwitchPage() {
      var pageName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "main";
    ...
    value: function InitSection() {
      ...
      TweenMax.set(this.$FirstLayer_Controller, {
        autoAlpha: 0
      });
      TweenMax.set(this.$FirstLayer_Bg, {
        autoAlpha: 0
      });
    } // Main Page Setup
    ...
    key: "MainPageIn",
    value: function MainPageIn() {
      var _this2 = this;

      var mainPageTimeline = new TimelineMax({
        paused: true,
        onComplete: function onComplete() {
          _this2.currentPage = "main";
          _this2.blockInteraction = false;

          _this2.BindSwapLayerEvent();
        }
      });
      mainPageTimeline.to(this.$FirstLayer_Bg, 1, {
        autoAlpha: 1
      });
      mainPageTimeline.staggerTo([this.$FirstLayer_Title, this.$FirstLayer_Sub_Title, this.$FirstLayer_Text], 0.5, {
        autoAlpha: 1,
        y: 1
      }, 0.25, "-=0.65");
      mainPageTimeline.to(this.$FirstLayer_Controller, 0.3, {
        autoAlpha: 1
      }, "-=0.25");
      mainPageTimeline.play();
    }
  }, {
    key: "BindSwapLayerEvent",
    value: function BindSwapLayerEvent() {
      var _this3 = this;

      this.$LayerSwitcherBtn.on("click", function (e) {
        if (!_this3.blockInteraction) {
          var targetParent = $(e.target).parents(".layer-switch");
          var targetPage = $(e.target).data("product");

          if (targetParent.length > 0) {
            targetPage = targetParent.data("product");
          }

          _this3.SwitchPage(targetPage);
        } else {
    ...
    value: function ToHomePage() {
      ...
      TweenMax.to(this.$CoverOverlay, 0.5, {
        scaleX: 1,
        onComplete: function onComplete() {
          TweenMax.set(_this4.$IntroFirstLayer, {
            autoAlpha: 1
          });
          TweenMax.to(_this4.$CoverOverlay, 0.5, {
            x: "100%",
            onComplete: function onComplete() {
              _this4.blockInteraction = false;
            }
          });
        }
      });
      ...
      if (this.currentPage == "main") {
        ...
        TweenMax.to(this.$CoverOverlay, 0.5, {
          ...
          onComplete: function onComplete() {
            ...
            _this5.InitXMENPage(true);

            TweenMax.set(_this5.$IntroFirstLayer, {
              autoAlpha: 0
            });
            TweenMax.to(_this5.$CoverOverlay, 0.5, {
              scaleX: 0,
              transformOrigin: "0% 50%",
              onComplete: function onComplete() {
                _this5.blockInteraction = false;
              }
            });
          }
        });
        ...
        TweenMax.to(this.$IntroDetail_X5_Control, 0.3, {
          autoAlpha: 0
        });
        TweenMax.to(this.$IntroDetail_X5_Images_Cover, 0.3, {
          x: "0%",
          onComplete: function onComplete() {
            TweenMax.set(_this5.$IntroDetail_X5_Images, {
              autoAlpha: 0
            });
            TweenMax.set(_this5.$IntroDetail_XMEN_Images, {
              autoAlpha: 1
            });
            TweenMax.set([_this5.$IntroDetail_XMEN_Title, _this5.$IntroDetail_XMEN_Text], {
              autoAlpha: 0,
              y: _this5.DISTANCE_Y
            });
            TweenMax.set([_this5.$IntroDetail_XMEN_Images_Items], {
              autoAlpha: 1
            });
            TweenMax.to(_this5.$IntroDetail_XMEN_Control, 0.3, {
              autoAlpha: 1
            });
            TweenMax.staggerTo([_this5.$IntroDetail_XMEN_Title, _this5.$IntroDetail_XMEN_Text], 0.4, {
              autoAlpha: 1,
              y: 0,
              delay: 0.2,
              onComplete: function onComplete() {
            ...
            TweenMax.to(_this5.$IntroDetail_XMEN_Images_Cover, 0.3, {
              x: "-100%",
              delay: 0.05,
              onComplete: function onComplete() {
                TweenMax.set(_this5.$IntroDetail_XMEN_Images_Cover, {
                  x: "100%"
                });
              }
            });
      ...
      if (this.currentPage == "main") {
        ...
        TweenMax.to(this.$CoverOverlay, 0.5, {
          ...
          onComplete: function onComplete() {
            ...
            _this6.InitX5Page(true);

            TweenMax.set(_this6.$IntroFirstLayer, {
              autoAlpha: 0
            });
            TweenMax.to(_this6.$CoverOverlay, 0.5, {
              scaleX: 0,
              transformOrigin: "0% 50%",
              onComplete: function onComplete() {
                _this6.blockInteraction = false;
              }
            });
          }
        });
        ...
        TweenMax.to(this.$IntroDetail_XMEN_Control, 0.3, {
          autoAlpha: 0
        });
        TweenMax.to(this.$IntroDetail_XMEN_Images_Cover, 0.3, {
          ...
          transformOrigin: "0% 50%",
          onComplete: function onComplete() {
            TweenMax.set(_this6.$IntroDetail_XMEN_Images, {
              autoAlpha: 0
            });
            TweenMax.set(_this6.$IntroDetail_X5_Images, {
              autoAlpha: 1
            });
            TweenMax.set([_this6.$IntroDetail_X5_Title, _this6.$IntroDetail_X5_Text], {
              autoAlpha: 0,
              y: _this6.DISTANCE_Y
            });
            TweenMax.set([_this6.$IntroDetail_X5_Images_Items], {
              autoAlpha: 1
            });
            TweenMax.to(_this6.$IntroDetail_X5_Control, 0.3, {
              autoAlpha: 1
            });
            TweenMax.staggerTo([_this6.$IntroDetail_X5_Title, _this6.$IntroDetail_X5_Text], 0.4, {
              autoAlpha: 1,
              y: 0,
              delay: 0.2,
              onComplete: function onComplete() {
            ...
            TweenMax.to(_this6.$IntroDetail_X5_Images_Cover, 0.3, {
              x: "-100%",
              delay: 0.05,
              onComplete: function onComplete() {
                TweenMax.set(_this6.$IntroDetail_X5_Images_Cover, {
                  x: "100%"
                });
              }
            });
    ...
    key: "InitX5Page",
    value: function InitX5Page() {
      var showPage = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

      if (showPage) {
        TweenMax.set([this.$IntroDetail_X5_Control, this.$IntroDetail_X5_Images_Items], {
          autoAlpha: 1
        });
        ...
        TweenMax.set(this.$IntroDetail_X5_Images_Cover, {
          x: "100%"
        }); // Hide XMEN layer

        TweenMax.set(this.$IntroDetail_X5_Images, {
          autoAlpha: 1
        });
        TweenMax.set(this.$IntroDetail_XMEN_Images, {
          autoAlpha: 0
        });
      } else {
        TweenMax.set([this.$IntroDetail_X5_Control, this.$IntroDetail_X5_Images_Items], {
    ...
    key: "InitXMENPage",
    value: function InitXMENPage() {
      var showPage = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

      if (showPage) {
        TweenMax.set([this.$IntroDetail_XMEN_Control, this.$IntroDetail_XMEN_Images_Items], {
          autoAlpha: 1
        });
        ...
        TweenMax.set(this.$IntroDetail_XMEN_Images_Cover, {
          x: "100%"
        }); // Hide X5 layer
...
function () {
  ...
  function Colors() {
    ...
    this.DISTANCE_Y = window.innerWidth * 0.05;
    this.currentPage = "xmen";
    this.BlockInteraction = false; // Elements Variables

    this.$ColorsSection = $("#yadea-xmen-colors"); // Main Content
    ...
    this.$ColorsControl = this.$ColorsMainContent.find(".product-swapper"); // Color Swapper

    this.$ColorsSwapBtn = this.$ColorsControl.find(".swap-btn"); // Effects
  ...
  _createClass(Colors, [{
    ...
    value: function bindEvents() {
      ...
      yadeaXMenListener.on("yadea-xmen-colors-anim", function () {
        _this2.starterTimeline.play();
      });
    }
    /* ===================================
     *  METHODS
    ...
    key: "InitSectionDesktop",
    value: function InitSectionDesktop() {
      // Init Section
      ...
      this.starterTimeline.staggerTo([this.$ColorsTitle, this.$ColorsSubTitle, this.$ColorsText, this.$ColorsControl], 0.5, {
        autoAlpha: 1,
        y: 0
      }, 0.25);

      if (this.currentPage == "xmen") {
        this.starterTimeline.to(this.$Colors_XMEN_Colors_Items, 0.25, {
          autoAlpha: 1,
          y: 0
        }, "-=0.2");
      } else {
        this.starterTimeline.to(this.$Colors_X5_Colors_Items, 0.25, {
          autoAlpha: 1,
          y: 0
        }, "-=0.2");
      }
    ...
    key: "InitSectionMobile",
    value: function InitSectionMobile() {
      // Config Slider
      ...
      TweenMax.set([this.$Colors_X5_Colors, this.$Colors_XMEN_Colors], {
        autoAlpha: 0,
        y: this.DISTANCE_Y
      }); // Init Section
      ...
      if (this.currentPage == "xmen") {
        this.starterTimeline.to(this.$Colors_XMEN_Colors, 0.5, {
          autoAlpha: 1,
          y: 0
        }, "-=0.2");
      } else {
        this.starterTimeline.to(this.$Colors_X5_Colors, 0.5, {
          autoAlpha: 1,
          y: 0
        }, "-=0.2");
      }
    ...
    key: "SetupColorsSwapper",
    value: function SetupColorsSwapper() {
      var _this3 = this;

      this.$ColorsSwapBtn.on("click", function (e) {
        if (!$(e.target).hasClass("active") && !_this3.BlockInteraction) {
          _this3.BlockInteraction = true;
          var $currentActiveBtn = $(".product-swapper .swap-btn.active");
          var targetProduct = $(e.target).data("target");
          $currentActiveBtn.removeClass("active");
          $(e.target).addClass("active");
          $(".product-swapper .swap-btn[data-target=\"".concat(targetProduct, "\"]")).addClass("active");

          _this3.SwitchColorSet(targetProduct);
        }
      });
    }
  }, {
    key: "SwitchColorSet",
    value: function SwitchColorSet() {
      var _this4 = this;

      var colorSet = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "xmen";

      if (colorSet === "xmen") {
        TweenMax.set(this.$Colors_XMEN_Colors, {
          zIndex: 1
        });
        TweenMax.set(this.$Colors_X5_Colors, {
          zIndex: 0
        });

        if (!IS_MOBILE) {
          TweenMax.staggerTo(this.$Colors_X5_Colors_Items, 0.3, {
            autoAlpha: 0,
            y: this.DISTANCE_Y * 0.25
          }, 0.15);
          TweenMax.staggerTo(this.$Colors_XMEN_Colors_Items, 0.3, {
            autoAlpha: 1,
            y: 0,
            delay: 0.3,
            onComplete: function onComplete() {
          ...
          TweenMax.to(this.$Colors_XMEN_Colors, 0.5, {
            ...
            delay: 0.25,
            onComplete: function onComplete() {
              TweenMax.set(_this4.$Colors_X5_Colors, {
                y: _this4.DISTANCE_Y
              });
              _this4.BlockInteraction = false;
            }
        ...
        if (!IS_MOBILE) {
          ...
          TweenMax.to(this.$Colors_X5_Colors, 0.5, {
            ...
            delay: 0.25,
            onComplete: function onComplete() {
              TweenMax.set(_this4.$Colors_XMEN_Colors, {
                y: _this4.DISTANCE_Y
              });
              _this4.BlockInteraction = false;
            }
...
function () {
  ...
  function Battery() {
    ...
    this.$BatterySection = $("#yadea-xmen-battery"); // Background

    this.$Battery_Bg = this.$BatterySection.find(".bg-holder"); // Main Content
    ...
    this.$Battery_Text = this.$BatteryMainContent.find(".text"); // Effect Elements

    this.$BatteryEffects = this.$BatterySection.find(".effect-holder");
    this.$BatteryEffects_Top = this.$BatteryEffects.find(".effect-top");
    this.$BatteryEffects_Bottom = this.$BatteryEffects.find(".effect-bottom"); // Starter Timeline
  ...
  _createClass(Battery, [{
    ...
    value: function bindEvents() {
      ...
      this.InitSection();
      yadeaXMenListener.on("yadea-xmen-battery-anim", function () {
        _this.starterTimeline.play();
      });
    }
    /* ===================================
    ...
    value: function InitSection() {
      ...
      TweenMax.set([this.$BatteryEffects_Top, this.$BatteryEffects_Bottom], {
        opacity: 0
      });
      this.starterTimeline.staggerTo([this.$Battery_Title, this.$Battery_Sub_Title, this.$Battery_Text], 0.5, {
        autoAlpha: 1,
        y: 0
      }, 0.25);
      this.starterTimeline.to([this.$BatteryEffects_Top, this.$BatteryEffects_Bottom], 0.35, {
        opacity: 1
      }, "-=0.2");
    }
  }]);
...
var _scrollmagic = _interopRequireDefault(__webpack_require__(0));

__webpack_require__(27);

var _scrollmagicPluginGsap = __webpack_require__(28);
...
(0, _scrollmagicPluginGsap.ScrollMagicPluginGsap)(_scrollmagic.default, TweenMax, TimelineMax);
...
function () {
  ...
  function Power() {
    ...
    this.DISTANCE_Y = window.innerWidth * 0.05;
    this.scrollMagicController = new _scrollmagic.default.Controller(); // Elements
  ...
  _createClass(Power, [{
    ...
    value: function bindEvents() {
      ...
      yadeaXMenListener.on("yadea-xmen-power-anim", function () {
        if (IS_MOBILE) {
          _this.mainAnimation.play();
        }
      });
    }
    /* ===================================
    ...
    value: function InitSectionDesktop() {
      ...
      TweenMax.set(this.$Power_Top_Text, {
        opacity: 0,
        y: this.DISTANCE_Y * 0.5
      });
      ...
      this.mainAnimation.to(this.$Power_Top_Text, 1, {
        opacity: 1,
        y: 0
      });
      this.mainAnimation.to(this.$Power_Top_Bg, 1, {
        opacity: 1,
        y: 0,
        scale: 1
      }, "-=0.8");
      this.mainAnimation.addLabel("endStep1+=1");
      this.mainAnimation.to(this.$Power_Top_Text, 0.5, {
        opacity: 0,
        y: this.DISTANCE_Y * 0.25
      }, "endStep1+=2");
      this.mainAnimation.to(this.$Power_Top_Bg, 4, {
        opacity: 0,
        scale: 1.5,
        y: this.DISTANCE_Y * 5,
        delay: 0.5
      }, "endStep1+=1.2");
      this.mainAnimation.to(this.$PowerEffect, 8, {
        y: -this.BOTTOM_HEIGHT * 0.475,
        ease: Linear.easeNone
      }, "endStep1+=1");
      this.mainAnimation.staggerTo([this.$Power_CounterShock_Label, this.$Power_CounterShock_Text], 1, {
        autoAlpha: 1,
        y: 0
      }, 0.5, "endStep1+=1.5");
      this.mainAnimation.staggerTo([this.$Power_BikeFrame_Label, this.$Power_BikeFrame_Text], 1, {
        autoAlpha: 1,
        y: 0
      }, 0.5, "endStep1+=3.25");
      this.mainAnimation.staggerTo([this.$Power_BikeBottom_Label, this.$Power_BikeBottom_Text], 1, {
        autoAlpha: 1,
        y: 0
      }, 0.5, "endStep1+=4.5");
      this.mainAnimation.staggerTo([this.$Power_WaterResist_Label, this.$Power_WaterResist_Text], 1, {
        autoAlpha: 1,
        y: 0
      }, 0.5, "endStep1+=5.75");
      this.mainAnimation.staggerTo([this.$Power_Engine_Label, this.$Power_Engine_Text], 1, {
        autoAlpha: 1,
        y: 0
      }, 0.5, "endStep1+=7");
      this.mainAnimation.staggerTo([this.$Power_Wheel_Label, this.$Power_Wheel_Text], 1, {
        autoAlpha: 1,
        y: 0
      }, 0.5, "endStep1+=10");
      var ScrollMagicPowerScreen = new _scrollmagic.default.Scene({
        triggerElement: "#yadea-xmen-power",
        duration: this.BOTTOM_HEIGHT * 0.7
      }) // .setPin("#yadea-xmen-power")
      .setTween(this.mainAnimation) // .addIndicators({ name: "2 (duration: 0)" }) // Open debug mode
    ...
    value: function InitSectionMobile() {
      ...
      this.mainAnimation.staggerTo([this.$Power_Top_Text_Title, this.$Power_Top_Text_Sub_Title, this.$Power_Top_Text_Context], 0.5, {
        autoAlpha: 1,
        y: 0
      }, 0.25);
      this.mainAnimation.to(this.$Power_Top_Bg, 0.6, {
        autoAlpha: 1,
        scale: 1
      }, "-=0.2");
    }
...
function () {
  ...
  function Maintainance() {
    ...
    _classCallCheck(this, Maintainance);

    this.DISTANCE_Y = window.innerWidth * 0.05; // Elements Variables

    this.$MaintainSection = $("#yadea-xmen-maintainance"); // Main Content
    ...
    this.$Maintain_Text = this.$Maintain_Content.find(".text"); // Effect Block

    this.$Maintain_Effect = this.$MaintainSection.find(".effect-holder");
    this.$Maintain_Bg = this.$Maintain_Effect.find(".bg-holder"); // this.$Maintain_Effect_Garage = this.$MaintainSection.find(".garage-layer");
    ...
    this.starterAnimation = new TimelineMax({
      paused: true,
      onComplete: function onComplete() {
        _this.$Maintain_Effect.addClass("floating");
      }
    });
    this.bindEvents();
  }
  ...
  _createClass(Maintainance, [{
    key: "bindEvents",
    value: function bindEvents() {
      var _this2 = this;

      this.InitSection();
      yadeaXMenListener.on("yadea-xmen-maintainance-anim", function () {
        _this2.starterAnimation.play();
      });
    }
    /* ===================================
     *  METHODS
    ...
    value: function InitSection() {
      ...
      this.starterAnimation.staggerTo([this.$Maintain_Title, this.$Maintain_Sub_Title, this.$Maintain_Text], 0.5, {
        autoAlpha: 1,
        y: 0
      }, 0.25);
      this.starterAnimation.to(this.$Maintain_Bg, 0.6, {
        autoAlpha: 1,
        y: 0
      }, "-=0.3"); // this.starterAnimation.to(this.$Maintain_Effect_Garage, 0.6, { autoAlpha: 1, y: 0 }, "-=0.2");
...
function () {
  ...
  function Comparision() {
    ...
    _classCallCheck(this, Comparision);

    this.DISTANCE_Y = window.innerWidth * 0.05; // Elements Variables

    this.$CompareSection = $("#yadea-xmen-comparision");
    this.$CompareMainContent = this.$CompareSection.find(".main-content"); // Compare Layout
  ...
  _createClass(Comparision, [{
    key: "bindEvents",
    value: function bindEvents() {
      var _this2 = this;

      this.InitSection();
      yadeaXMenListener.on("yadea-xmen-comparision-anim", function () {
        _this2.starterAnimation.play();
      });
    }
    /* ===================================
    ...
    key: "InitSection",
    value: function InitSection() {
      TweenMax.set(this.$CompareMainContent, {
        autoAlpha: 0,
        y: this.DISTANCE_Y * 0.25
      });
      ...
      this.starterAnimation.to([this.$Compare_Layout_Column_Top, this.$Compare_Layout_Column_Bottom, this.$Compare_Layout_Options], 0.6, {
        autoAlpha: 1
      }, "-=0.1");
    }
  }, {
    key: "SetupCompareProduct",
    value: function SetupCompareProduct() {
      var _this3 = this;

      this.$Compare_Layout_Options_Btn.on("click", function (e) {
        if (!$(e.target).hasClass("active")) {
          var targetOption = $(e.target).data("target");

          _this3.$Compare_Layout_Options_Btn.removeClass("active");

          $(e.target).addClass("active");

          _this3.$Compare_Layout_CompareList.removeClass("active");

          $("#xmen-data__".concat(targetOption)).addClass("active");
          $("#x5-data__".concat(targetOption)).addClass("active");
        }
      });
    }
  }]);
...
function () {
  ...
  function Brake() {
    ...
    this.$BrakeSection = $("#yadea-xmen-brake"); // Main Content
    ...
    this.$Brake_Text = this.$BrakeContent.find(".text"); // Effect Holder

    this.$BrakeEffect = this.$BrakeSection.find(".effect-holder");
    this.$Brake_Back_Brake = this.$BrakeEffect.find(".brake-effect.back-brake");
    this.$Brake_Back_Image = this.$Brake_Back_Brake.find(".main-image"); // this.$Brake_Back_Highlight = this.$Brake_Back_Brake.find(".main-highlight");
    ...
    this.$Brake_Front_Image = this.$Brake_Front_Brake.find(".main-image"); // this.$Brake_Front_Highlight = this.$Brake_Front_Brake.find(".main-highlight");
    ...
    this.starterAnimation = new TimelineMax({
      paused: true,
      onComplete: function onComplete() {// this.BrakeEffectTimeline.play();
      }
    });
    this.bindEvents();
  }
  ...
  _createClass(Brake, [{
    ...
    value: function bindEvents() {
      ...
      this.InitSection();
      yadeaXMenListener.on("yadea-xmen-brake-anim", function () {
        _this.starterAnimation.play();
      });
    }
    /* ===================================
     *  METHODS
    ...
    value: function InitSection() {
      ...
      this.starterAnimation.staggerTo([this.$Brake_Title, this.$Brake_Sub_Title, this.$Brake_Text], 0.5, {
        autoAlpha: 1,
        y: 0
      }, 0.25);
      ...
      this.starterAnimation.to([this.$Brake_Back_Highlight_2, this.$Brake_Front_Highlight_2], 0.6, {
        autoAlpha: 1,
        x: "0%",
        scaleX: 1,
        transformOrigin: "0% 50%"
      }, "-=0.2"); // Brake Effect Timeline Build
...
function () {
  ...
  function Distance() {
    ...
    this.nextProduct = "x5"; // Section Variables
    ...
    this.$Distance_Text = this.$DistanceMainContent.find(".text"); // Effect

    this.$DsitanceEffect = this.$DistanceSection.find(".effect-holder");
    this.$DsitanceEffect_Bg = this.$DsitanceEffect.find(".bg-effect");
    this.$DsitanceEffect_Bike = this.$DsitanceEffect.find(".main-effect .bike-holder"); // this.$DsitanceEffect_Bike_X5 = this.$DsitanceEffect.find(".main-effect .bike-holder.bike-x5");

    this.$DsitanceEffect_EffectSwapper = this.$DsitanceEffect.find(".effect-swapper"); // Swapper Product
  ...
  _createClass(Distance, [{
    ...
    value: function bindEvents() {
      ...
      this.InitSection();
      yadeaXMenListener.on("yadea-xmen-distance-anim", function () {
        _this2.starterAnimation.play();
      });
    }
    /* ===================================
    ...
    value: function InitSection() {
      ...
      // Init State
      TweenMax.set([this.$Distance_Title, this.$Distance_Sub_Title, this.$Distance_Text, this.$DsitanceEffect_EffectSwapper], {
        autoAlpha: 0,
        y: this.DISTANCE_Y * 0.25
      });
      ...
      this.starterAnimation.to(this.$DsitanceEffect_Bg, 0.5, {
        autoAlpha: 1
      });
      this.starterAnimation.staggerTo([this.$Distance_Title, this.$Distance_Sub_Title, this.$Distance_Text], 0.5, {
        autoAlpha: 1,
        y: 0
      }, 0.25, "-=0.25");
      ...
      this.starterAnimation.to(this.$DsitanceEffect_EffectSwapper, 0.25, {
        autoAlpha: 1,
        y: 0
      }, "-=0.3"); // Bike Run

      this.bikeRunAnimation.to(this.$DsitanceEffect_Bg, this.SPEED_TIME, {
        x: "-200%",
        ease: Power0.inOut
      });
      ...
      this.bikeRunAnimation.addCallback(function () {
        _this3.$DsitanceEffect_Bike.removeClass("night");

        _this3.bikeRunAnimation.resume();
      }, "endNight");
      this.bikeRunAnimation.addCallback(function () {
        _this3.$DsitanceEffect_Bike.addClass("night");
    ...
    key: "StartBikeAnim",
    value: function StartBikeAnim() {
      this.BIKE_IS_PLAYING = true;
      this.bikeRunAnimation.play(); // this.$DistanceSwapBtn.on("click", (e) => {
...
function () {
  ...
  function SmartKey() {
    ...
    _classCallCheck(this, SmartKey);

    this.DISTANCE_Y = window.innerWidth * 0.05;
    this.PARALLAX_DISTANCE = 6 * window.innerWidth / 1920; // Elements Variables
    ...
    this.$Smartkey_Text = this.$SmartkeyContent.find(".text"); // Effect

    this.$SmartkeyEffect = this.$SmartkeySection.find(".effect-holder"); // Feature List
    ...
    this.starterAnimation = new TimelineMax({
      paused: true,
      onComplete: function onComplete() {
        _this.BindParallaxBehavior();

        _this.BindSmartKeyBehavior();

        if (IS_MOBILE) {
          _this.BindInfoToggler();
        }
      }
    });
  ...
  _createClass(SmartKey, [{
    key: "bindEvents",
    value: function bindEvents() {
      var _this2 = this;

      this.InitSection();
      yadeaXMenListener.on("yadea-xmen-smartkey-anim", function () {
        _this2.starterAnimation.play();
      });
    }
    /* ===================================
    ...
    value: function InitSection() {
      // Init Section
      TweenMax.set([this.$Smartkey_Title, this.$Smartkey_Sub_Title, this.$Smartkey_Text, this.$SmartkeyEffect_FeatureList], {
        autoAlpha: 0,
        y: this.DISTANCE_Y * 0.25
      });
      TweenMax.set([this.$SmartkeyEffect_Main_Wave_1, this.$SmartkeyEffect_Main_Wave_2, this.$SmartkeyEffect_Main_Wave_3, this.$SmartkeyEffect_Main_Wave_4, this.$SmartkeyEffect_Main_Bike_Shadow_1, this.$SmartkeyEffect_Main_Bike_Shadow_2, this.$SmartkeyEffect_Main_Bike_Shadow_3, this.$SmartkeyEffect_Main_Bike_Lighting1, this.$SmartkeyEffect_Main_Bike_Lighting2], {
        autoAlpha: 0
      });
      TweenMax.set(this.$SmartkeyEffect_Main_Bg, {
        autoAlpha: 0,
        y: this.DISTANCE_Y
      });
      TweenMax.set(this.$SmartkeyEffect_Main_Bike_Image, {
        autoAlpha: 0,
        y: -this.DISTANCE_Y
      }); // Build Animation

      this.starterAnimation.staggerTo([this.$Smartkey_Title, this.$Smartkey_Sub_Title, this.$Smartkey_Text, this.$SmartkeyEffect_FeatureList], 0.5, {
        autoAlpha: 1,
        y: 0
      }, 0.25);
      this.starterAnimation.to([this.$SmartkeyEffect_Main_Bg, this.$SmartkeyEffect_Main_Bike_Image, this.$SmartkeyEffect_Main_Bike_Shadow_3], 0.6, {
        autoAlpha: 1,
        y: 0
      });
    }
  }, {
    key: "BindParallaxBehavior",
    value: function BindParallaxBehavior() {
      var _this3 = this;
      ...
      TweenMax.to(this.$SmartkeyEffect_Main_Bike_Shadow_2, 0.5, {
        ...
        onComplete: function onComplete() {
          if (window.innerWidth > 767) {
            _this3.$SmartkeySection.on("mousemove", function (e) {
              var coreData = {
                offsetX: e.clientX,
                offsetY: e.clientY,
                core: {
                  x: _this3.$SmartkeySection.width() / 2,
                  y: _this3.$SmartkeySection.height() / 2
                }
              };
              var calculatedData = {
                xMove: _this3.PARALLAX_DISTANCE * (coreData.offsetX - coreData.core.x) / coreData.core.x,
                yMove: _this3.PARALLAX_DISTANCE * (coreData.offsetY - coreData.core.y) / coreData.core.y
              };
              TweenMax.to(_this3.$SmartkeyEffect_Main_Bike_Shadow_1, 0.5, {
                x: -calculatedData.xMove,
                y: -calculatedData.yMove
              });
              TweenMax.to(_this3.$SmartkeyEffect_Main_Bike_Shadow_2, 0.5, {
                x: calculatedData.xMove,
                y: calculatedData.yMove
              });
            });
    ...
    key: "BindSmartKeyBehavior",
    value: function BindSmartKeyBehavior() {
      this.smartkeyTimeline.staggerTo([this.$SmartkeyEffect_Main_Wave_4, this.$SmartkeyEffect_Main_Wave_3, this.$SmartkeyEffect_Main_Wave_2, this.$SmartkeyEffect_Main_Wave_1], 0.3, {
        autoAlpha: 1,
        scale: 1.05,
        x: this.DISTANCE_Y * 0.04
      }, 0.05);
      this.smartkeyTimeline.to([this.$SmartkeyEffect_Main_Wave_4, this.$SmartkeyEffect_Main_Wave_3, this.$SmartkeyEffect_Main_Wave_2, this.$SmartkeyEffect_Main_Wave_1], 0.25, {
        autoAlpha: 0
      });
      this.smartkeyTimeline.addLabel("startResponse");
      this.smartkeyTimeline.fromTo(this.$SmartkeyEffect_Main_Bike_Lighting1, 0.3, {
        autoAlpha: 0,
      ...
      this.smartkeyTimeline.to(this.$SmartkeyEffect_Main_Bike_Lighting1, 0.2, {
        autoAlpha: 0,
        scale: 1.1
      }, "startResponse-=0.2");
      this.smartkeyTimeline.fromTo(this.$SmartkeyEffect_Main_Bike_Lighting2, 0.3, {
        autoAlpha: 0,
      ...
      this.smartkeyTimeline.to(this.$SmartkeyEffect_Main_Bike_Lighting2, 0.2, {
        autoAlpha: 0,
        scale: 1.1
      }, "startResponse-=0.2");
    }
    ...
    key: "BindInfoToggler",
    value: function BindInfoToggler() {
      var _this4 = this;

      this.$SmartkeyEffect_FeatureList_Item.on("click", function (e) {
        var $processItem = $(e.target);
        ...
        if (!$processItem.hasClass("active")) {
          _this4.$SmartkeyEffect_FeatureList_Item.removeClass("active");

          $processItem.addClass("active");
          var $showContext = $processItem.find(".context");

          _this4.$SmartkeyEffect_FeatureList_Item_Context.slideUp("fast");

          $showContext.slideDown("fast");
        } else {
          $processItem.removeClass("active");

          var _$showContext = $processItem.find(".context");

          _$showContext.slideUp("fast");
        }
      });
    }
  }]);
