            ...
            <div class="col-lg-10 col-6 header__menu">
                ...
                <ul class="nav justify-content-end mb-hide">
                    ...
                    <li class="nav-item <?php if(is_page('/shops')) echo 'active'; ?>">
                        <a target="_self" class="nav-link" href="<?php echo site_url('/shops') ?>">Cửa hàng</a>
                    </li>
            ...
            <div class="sub-menu-row">
                ...
                <ul class="sub-menu-main">
                    <li class="close-sub-menu">
                        <a target="_self" href="<?=site_url('/yadea-e3/#section-e3-design')?>">Thông tin sản phẩm</a>
                    </li>
                    <li class="close-sub-menu">
                        <a target="_self" href="<?=site_url('/chi-tiet/yadea-e3/')?>">Thông số kỹ thuật</a>
                    </li>
                    <li class="close-sub-menu">
                        <a target="_self">Giá: <b>15,990,000 VND</b></a>
                    </li>
                </ul>
