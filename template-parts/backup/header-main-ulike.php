  ...
  <div class="container header">
    ...
    <div class="row">
      ...
      <div class="col-lg-2 col-6 header__logo">
        <a target="_self" href="<?php echo site_url(); ?>">
      ...
      <div class="col-lg-10 col-6 header__menu">
        ...
        <ul class="nav justify-content-end mb-hide">
          <li class="nav-item <?php if(is_page('products')) echo 'active'; ?>" id="sub-menu-trigger">
            <a target="_self" class="nav-link" href="<?php echo site_url('/products'); ?>">Sản phẩm</a>
          </li>
          <li class="nav-item <?php if(is_page('/shops')) echo 'active'; ?>">
            <a target="_self" class="nav-link" href="<?php echo site_url('/shops') ?>" target="_self">Cửa hàng</a>
          </li>
          <li id="about-us-sub-menu-trigger" class="nav-item <?php if(is_page('/about-us')) echo 'active'; ?>">
            <a target="_self" class="nav-link" href="<?php echo site_url('/about') ?>">Về chúng tôi</a>
          </li>
          <li class="nav-item <?php if(is_page('support')) echo 'active'; ?>">
            <a target="_self" class="nav-link" href="<?php echo site_url('/support') ?>">Hỗ trợ</a>
          </li>
        </ul>
        <!-- Header Main Menu -->
    ...
    <div class="sub-menu__wrapper row">
      ...
      <div class="col-md-4 col-6 sub-menu__wrapper__item">
        ...
        <div class="sub-menu__wrapper__item__detail">
          <a target="_self" href="<?php echo site_url('/about'); ?>">
      ...
      <div class="col-md-4 col-6 sub-menu__wrapper__item">
        <!-- About Detail Wrapper -->
        <div class="sub-menu__wrapper__item__detail">
          <a target="_self" href="<?php echo site_url('/course'); ?>">
            <div class="about-us__thumbnail">
      ...
      <div class="col-md-4 col-6 sub-menu__wrapper__item">
        ...
        <!-- About Detail Wrapper -->
        <div class="sub-menu__wrapper__item__detail">
          <a target="_self" href="<?php echo site_url('/supplier'); ?>">
            <div class="about-us__thumbnail">
      ...
      <div class="sub-menu-row">
        ...
        <ul class="sub-menu-main">
          <li class="close-sub-menu">
            <a target="_self" href="<?=site_url('/yadea-ulike/#section-ulike-feature')?>">Thông tin sản phẩm</a>
          </li>
          <li class="close-sub-menu">
            <a target="_self" href="<?=site_url('/chi-tiet/yadea-ulike/')?>">Thông số kỹ thuật</a>
          </li>
          <li class="close-sub-menu">
            <span>Giá: <b>18,990,000 VND</b></span>
          </li>
        </ul>

        <!-- Price CTA -->
        <div class="cta-wrapper">
          <a target="_self" class="cta" href="<?php echo site_url( '/shops' );?>">MUA NGAY</a>
        </div>
        <!-- Price CTA -->
      </div><!-- Price Row -->
