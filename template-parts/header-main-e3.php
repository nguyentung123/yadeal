  ...
  <div class="container">
   ...
   <div class="sub-menu-row">
    ...
    <ul class="sub-menu-main">
     ...
     <li class="close-sub-menu">
      <a>Giá bán lẻ đề xuất: <b>15,990,000 VND</b></a>
     </li>
    </ul>
    ...
    <div class="cta-wrapper">
     <p class="price-holder mb-show" style="margin: 0 10px;">
      Giá bán lẻ đề xuất: <b>15,990,000 VND</b>
     </p>
     <a class="cta open-signup-info-modal track-this-button" id="header-buynow-e3-button" style="cursor:pointer;">MUA
      NGAY</a>
    </div>
    <!-- Price CTA -->
   </div><!-- Price Row -->
