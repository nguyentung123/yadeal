   ...
   <div class="price-row">
    ...
    <div class="price-cta-wrapper">
     <p class="price-holder">
      Giá bán lẻ đề xuất: <span class="price-value">39,990,000 VND</span>
     </p>
     <a class="price-cta open-signup-info-modal track-this-button" id="header-yadea-g5-buynow-btn"
...
@media (max-width: 480px) {
 ...
 .price-cta-wrapper .price-holder {
  padding: 0 3px;
 }
}
