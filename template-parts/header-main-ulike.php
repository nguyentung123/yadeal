            ...
            <div class="sub-menu-row">
                ...
                <ul class="sub-menu-main">
                    <li class="close-sub-menu">
                        <a href="https://yadeavietnam.vn/yadea-ulike#section-ulike-feature">Thông tin sản phẩm</a>
                    </li>
                    ...
                    <!--                    </li>-->
                    <li class="close-sub-menu">
                        <a href="https://yadeavietnam.vn/yadea-ulike#specs-section">Thông số kỹ thuật</a>
                    </li>
                </ul>
