    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-12 product-showcase__item">
        ...
        <div class="product-showcase__item__top text-center">
          <a href="<?php echo get_field('product_landing_page', get_field('banner_product')); ?>">
        ...
        <!-- Product Item Body -->
        <a class="product-showcase__item__body"
          href="<?php echo get_field('product_landing_page', get_field('banner_product')); ?>">
