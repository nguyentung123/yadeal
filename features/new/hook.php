...
function getBanner($bannerPosition = 1){
    $listBannerOptions = [
        ...
        'download_app_banner'    => array(
            'priority'        => (int)get_theme_mod('download_app_banner_priority'),
            'show'            => (int)get_theme_mod('download_app_banner_show'),
        ),
    ];
        ...
        foreach($renderList as $value){
            switch($value){
                ...
                case 'oxygen_banner':
                    ...
                    break;
                case 'download_app_banner':
                    get_template_part('template-parts/home', 'download-app-section');
                    break;
                default:
                    break;
            }
