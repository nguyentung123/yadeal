...
<main class="no-overlay support-pages">
  ...
  <div class="common-banner" id="privacy-banner-section">
    ...
    <div class="container">
      ...
      <!-- Background Holder -->
      <div class="bg-holder" id="support-maintain-banner-bg">
        <div class="img-holder">
          <img alt="banner privacy icon" class="mb-hide" src="<?php echo get_theme_file_uri('assets/img/update-dec/maintain-banner.jpg'); ?>">
          <img alt="banner privacy icon" class="mb-show" src="<?php echo get_theme_file_uri('assets/img/update-dec/maintain-banner-mb.jpg'); ?>">
        </div>
      </div>
      ...
      <div class="main-content">
        ...
        <p class="desc">
          Yadea xây dựng chính sách bảo hành hấp dẫn<br>
          với những điều kiện chặt chẽ, đảm báo quyền<br>
          lợi tối đa của khách hàng
        </p>
      </div>
      <!-- Main Content -->
        ...
        <ul class="topic-list">
          ...
          <li class="topic-item">
            ...
            <ul class="sub-topic-holder">
              ...
              <li class="sub-topic-item">
                <p class="sub-topic-title">1. Thời hạn bảo hành</p>
                <p class="sub-topic-content">
                  Thời hạn bảo hành bắt đầu từ lúc mua sản phẩm bởi người sử dụng cuối cùng đầu tiên. Sản phẩm có thể
                  bao gồm nhiều phần khác nhau và những phần này có thể có thời gian bảo hành không giống nhau.
                  Thời gian bảo hành cụ thể của từng phần được quy định tại sổ bảo hành theo từng model xe.
                </p>
              </li>
              <!-- Sub Topic Item - END -->
              ...
              <!-- Sub Topic Item -->
              <li class="sub-topic-item">
                <p class="sub-topic-title">2. Đổi trả, sửa chữa trong thời hạn bảo hành</p>
                <p class="sub-topic-content">
                  •	Trong thời hạn 15 ngày đầu tiên tính từ ngày bán ra cho người sử dụng, nếu xe gặp phải những lỗi
                  do nhà sản xuất (với điều kiện đã loại trừ những trường hợp can thiệp bên ngoài về việc thay đổi kết
                  cấu xe, lỗi phụ tùng hoặc các lỗi khác gây ra do sử dụng không đúng cách theo sách hướng dẫn),
          ...
          <li class="topic-item">
            ...
            <ul class="sub-topic-holder">
              ...
              <!-- Sub Topic Item -->
              <li class="sub-topic-item">
                <p class="sub-topic-title">1. Liên quan đến PIN/Ắc quy </p>
                <p class="sub-topic-content">
                  Tuổi thọ của Pin/Ắc quy phụ thuộc rất nhiều vào cách sạc Pin/Ắc quy, dòng điện sạc, số lần xả Pin/Ắc
                  quy và nhiệt độ môi trường trong quá trình sử dụng. Khách hàng cần đọc kỹ sách hướng dẫn sử dụng để
                  hiểu rõ cách sử dụng và cách sạc Pin/Ắc quy đúng cách. Dung lượng tối đa của Pin/Ắc quy sẽ giảm dần
                  theo thời gian do đặc tính chai tự nhiên, nên tình trạng chai tự nhiên của Pin/Ắc quy không nằm trong
                  phạm vi bảo hành. Các hiện tượng phồng, nứt, vỡ, cháy, nổ, bốc khói của Pin/Ắc quy gây ra bởi các
                  nguyên nhân từ đỗ xe dưới môi trường có nhiệt độ cao, sử dụng sạc không chính hãng, lắp đặt với các
                  thiết bị tiêu thụ điện khác, thay đổi so với thiết kế ban đầu của người sử dụng, v.v… sẽ không nằm
              ...
              <!-- Sub Topic Item -->
              <li class="sub-topic-item">
                <p class="sub-topic-title">2. Thông tin trên phiếu bảo hành</p>
                <p class="sub-topic-content">
                  Quý khách hàng phải điền chính xác đầy đủ các thông tin như: họ tên, địa chỉ liên lạc, số điện thoại,
                  loại xe ,số khung,số động cơ,mã Pin… vào phiếu bảo hành.
                </p>
              </li>
              <!-- Sub Topic Item - END -->
              ...
              <!-- Sub Topic Item -->
              <li class="sub-topic-item">
                <p class="sub-topic-title">3. Thủ tục nhận xe sau khi bảo hành</p>
                <p class="sub-topic-content">
                  Khi đến nhận xe, yêu cầu quý khách hàng mang theo phiếu bảo hành sữa chữa của YADEA, nếu phiếu bảo
                  hành bị thất lạc quý khách hàng cần mang giấy tờ khác chứng minh đã mang xe đến Trung Tâm Chăm Sóc
                  Khách Hàng YADEA.<br>
                  + Những trường hợp phát sinh, nhân viên hệ thống trung tâm bảo hành sẽ thông báo cụ thể đến quý
                  khách hàng<br>
                  + Tất cả các linh kiện phụ tùng của Sản phẩm hoặc các thiết bị khác mà YADEA thay thế sẽ trở thành
                  tài sản của YADEA.<br>
                  + Sản phẩm của bạn là xe máy điện thông minh, YADEA khuyến khích bạn hãy đọc kỹ hướng dẫn sử dụng và
                  những hướng dẫn được cung cấp trong sách hướng dẫn của sản phẩm.<br>
                  + Tất cả các thông tin về bảo hành, tính năng và đặc điểm của sản phẩm có thể thay đổi mà không cần
                  thông báo trước.<br>
                </p>
              </li>
              <!-- Sub Topic Item - END -->
          ...
          <li class="topic-item">
            ...
            <!-- Title -->
            <h3 class="topic-title">
              IV. Dịch vụ sữa chữa ngoài bảo hành
            </h3>
            <!-- Title - END -->
            ...
            <p class="topic-context">
              Khi sản phẩm hết hạn bảo hành,hoặc thuộc diện từ chối bảo hành. Trung Tâm Chăm Sóc Khách Hàng YADEA có
              trách nhiệm sữa chữa với chất lượng dịch vụ tốt nhất, khách hàng sẽ trả tất cả chi phí phát sinh như đã
              thỏa thuận trước cho linh kiện ,phụ tùng theo giá quy định của công ty
            </p>
            <!-- Sub Topic List - END -->
