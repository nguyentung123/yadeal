  ...
  <div class="common-banner" id="support-banner-section">
    ...
    <div class="container">
      ...
      <div class="bg-holder" id="support-main-banner-bg">
        <div class="img-holder">
          <img alt="banner privacy icon"
            src="<?php echo get_theme_file_uri('assets/img/update-dec/support-banner.png'); ?>">
        </div>
      </div>
      ...
      <div class="main-content">
        ...
        <p class="desc">
          YADEA cam kết mang đến cho <br class="mb-show">khách hàng<br class="mb-hide"> những chính sách và<br
            class="mb-show"> dịch vụ chất lượng nhất
        </p>
      </div>
      <!-- Main Content -->
    ...
    <div class="container">
      ...
      <div class="support-action-holder">
        ...
        <a class="support-action-item" href="<?php echo site_url('huong-dan-su-dung'); ?>">
          <div class="action-icon">
            <img src="<?php echo get_theme_file_uri('assets/img/update-dec/support-instruction.png'); ?>">
          </div>
          <div class="action-context">
      ...
      <div class="form-field">
        ...
        <span class="loading-form" style="display: none;">
          <svg class="lds-spinner" width="200px" height="200px" xmlns="http://www.w3.org/2000/svg"
            ...
            style="shape-rendering: auto;animation-play-state: running;animation-delay: 0s;background: none;width: 38px;height: 38px;display: inline-block;margin-bottom: -15px;">
